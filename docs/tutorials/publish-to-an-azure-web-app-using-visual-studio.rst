...
===============================================
By :ref:`Erik Reitan <publish-to-an-azure-web-app-using-visual-studio-author>` | Originally Published: 28 April 2015 
...
.. image:: publish-to-an-azure-web-app-using-visual-studio/_static/01-Publish.png

2. In the **Publish Web** dialog box, click on **Microsoft Azure Web Apps** and log into your Azure subscription.

.. image:: publish-to-an-azure-web-app-using-visual-studio/_static/02-PublishWebdb.png

3. Click **New** in the **Select Existing Web App** dialog box to create a new Web app in Azure.

.. image:: publish-to-an-azure-web-app-using-visual-studio/_static/03-SelectExistingWebAppdb.png
...
.. image:: publish-to-an-azure-web-app-using-visual-studio/_static/04-CreateWebAppOnMicrosoftAzuredb.png
...
.. image:: publish-to-an-azure-web-app-using-visual-studio/_static/05-PublishWebdb.png

You can view the publishing progress in the **Web Publish Activity** window within Visual Studio.

.. image:: publish-to-an-azure-web-app-using-visual-studio/_static/06-WebPublishActivityWindow.png

When publishing to Azure is complete, your web app will be displayed in a browser running on Azure. 

.. image:: publish-to-an-azure-web-app-using-visual-studio/_static/07-Browser.png


.. _publish-to-an-azure-web-app-using-visual-studio-author:
