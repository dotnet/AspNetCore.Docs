...
The data protection system is normally designed :doc:`to be added to a service container <consumer-apis>` and to be provided to dependent components via a DI mechanism. However, there may be some cases where this is not feasible, especially when importing the system into an existing application.
...
.. literalinclude:: _static/nodisample1.cs
        :language: c#
        :linenos:
...
.. literalinclude:: _static/nodisample2.cs
        :language: c#
        :linenos:
