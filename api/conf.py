...
# -*- coding: utf-8 -*-
#
# ASP.NET API Reference documentation build configuration file, created by
# sphinx-quickstart on Sat Nov 14 22:03:01 2015.
#
...
htmlhelp_basename = 'aspnetapidocs'
...
latex_documents = [
  (master_doc, 'aspnetapidocs.tex', 'ASP.NET API Reference Documentation',
   'Microsoft', 'manual'),
]
...
man_pages = [
    (master_doc, 'aspnetapidocs', 'ASP.NET API Reference Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'aspnetapidocs', 'ASP.NET API Reference Documentation',
   author, 'aspnetapidocs', 'ASP.NET API Reference Documentation',
   '.NET Development'),
]
