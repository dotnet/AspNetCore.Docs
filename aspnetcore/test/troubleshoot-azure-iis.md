...
This error also may occur when the .NET Core Hosting Bundle isn't installed or is corrupted. We recommend re-installing or repairing the installation of the .NET Core Hosting Bundle (for IIS) or Visual Studio (for IIS Express).
