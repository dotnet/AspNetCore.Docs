...
The preceding screenshot shows endpoints defined by the ASP.NET Core Web API project template. The following example shows the request that is generated for the selected endpoint:
