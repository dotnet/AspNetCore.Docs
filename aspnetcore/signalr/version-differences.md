...
Use the [on](/javascript/api/@microsoft/signalr/HubConnection) method to specify client methods that the hub can call.
...
Use the [on](/javascript/api/@aspnet/signalr/HubConnection) method to specify client methods that the hub can call.
...
Hub proxies are no longer automatically generated. Instead, the method name is passed into the [invoke](/javascript/api/@microsoft/signalr/hubconnection) API as a string.

::: moniker-end

::: moniker range="<= aspnetcore-2.2"

Hub proxies are no longer automatically generated. Instead, the method name is passed into the [invoke](/javascript/api/@aspnet/signalr/hubconnection) API as a string.
