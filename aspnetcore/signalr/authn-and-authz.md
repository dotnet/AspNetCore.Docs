...
Windows Authentication isn't supported in all browsers. In some browsers, such as Chrome and Safari:

* WebSockets with Windows Authentication doesn't work.
* The client tries to fall back to other transports.
