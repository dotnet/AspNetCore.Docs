namespace CachingMemorySample
{
    public static class CacheKeys
    {
        ...
        // public const string DependentMessage = "_DependentMessage";

        public const string DependentCancellationTokenSource = "_DependentCancellationTokenSource";

        // public const string Ticks = "_Ticks";

        // public const string CancelMessage = "_CancelMessage";

        // public const string CancelTokenSource = "_CancelTokenSource";
    }
}
