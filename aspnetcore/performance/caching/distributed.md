...
[View or download sample code](https://github.com/aspnet/Docs/tree/master/aspnetcore/performance/caching/distributed/samples/2.x/DistCacheSample) ([how to download](xref:tutorials/index#how-to-download-a-sample))
