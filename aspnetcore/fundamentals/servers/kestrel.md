...
* When targeting linux, app shut down and restart may fail to restart UNIX socket. For more information, see [this GitHub issue](https://github.com/dotnet/aspnetcore/issues/14134).
