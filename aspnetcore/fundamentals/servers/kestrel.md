...
ASP.NET Core project templates use Kestrel by default. In *Program.cs*, `ConfigureWebHostDefaults` calls <xref:Microsoft.AspNetCore.Hosting.WebHostBuilderKestrelExtensions.UseKestrel*> behind the scenes:
