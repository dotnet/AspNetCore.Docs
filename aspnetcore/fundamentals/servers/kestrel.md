...
ASP.NET Core project templates use Kestrel by default. In *Program.cs*, the `ConfigureWebHostDefaults` method calls <xref:Microsoft.AspNetCore.Hosting.WebHostBuilderKestrelExtensions.UseKestrel*> :
