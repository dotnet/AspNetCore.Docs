...
* [Kestrel server](xref:fundamentals/servers/kestrel) is the default, cross-platform HTTP server implementation. Kestrel provides the best performance and memory utilization, but it doesn't have some of the advanced features in HTTP.sys. For more information, 
* see [Kestrel vs. HTTP.sys](#korh)
*  in the next section.
...
<a name="korh"></a> <!-- needed for multi moniker collisions -->
