...
* Configure URLs and ports to listen on 
  ...
  By default WebListener binds to `http://localhost:5000`. To configure URL prefixes and ports, you can use the `UseURLs` extension method, the `server.urls` command line argument or the ASP.NET Core configuration system. For more information, see [Hosting](../../fundamentals/hosting.md).
...
* [WebListener source code](https://github.com/aspnet/WebListener)
* [Hosting](../hosting.md)
