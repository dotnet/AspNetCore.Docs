...
The <xref:Microsoft.Extensions.Logging.ILogger> and <xref:Microsoft.Extensions.Logging.ILoggerFactory> interfaces are provided by the [Microsoft.Extensions.Logging.Abstractions](https://www.nuget.org/packages/Microsoft.Extensions.Logging.Abstractions/) package. Default implementations are in [Microsoft.Extensions.Logging](https://www.nuget.org/packages/microsoft.extensions.logging/).

::: moniker range=">= aspnetcore-2.1"

The `Microsoft.Extensions.Logging.Abstractions` and `Microsoft.Extensions.Logging` packages are made available to the app by referencing the [Microsoft.AspNetCore.App metapackage](xref:fundamentals/metapackage-app).
