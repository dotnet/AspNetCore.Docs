...
[!code-csharp[](index/samples/3.x/TodoApiSample/Program.cs?name=snippet_ExpandDefault&highlight=17)]
...
!code-csharp[](index/samples/3.x/TodoApiSample/Program.cs?name=snippet_FilterFunc)]

::: moniker-end

::: moniker range="< aspnetcore-3.0"

!code-csharp[](index/samples/2.x/TodoApiSample/Program.cs?name=snippet_FilterFunc)]
