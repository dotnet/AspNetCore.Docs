...
[!code-csharp[](samples/8.x/Program.cs?name=snippet2&highlight=3,7)]
...
[!code-csharp[](samples/8.x/Program.cs?name=snippet_Addservices)]
...
[!code-csharp[](samples/8.x/Program.cs?name=snippet_Addservices&highlight=8,9)]

### `MediaTypeOptions`

<xref:Microsoft.AspNetCore.HttpLogging.HttpLoggingOptions.MediaTypeOptions> provides configuration for selecting which encoding to use for a specific media type.

[!code-csharp[](samples/8.x/Program.cs?name=snippet_Addservices&highlight=10)]
...
[!code-csharp[](samples/8.x/Program.cs?name=snippet_Addservices&highlight=11-12)]
