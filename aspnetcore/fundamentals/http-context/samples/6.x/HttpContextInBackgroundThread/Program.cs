...
app.MapGet("/branches", async (IHttpClientFactory httpClientFactory, HttpContext context,
                                                              ILogger<Program> logger) =>
{
    ...
    app.Logger.LogInformation($"/branches request: {JsonSerializer.Serialize(response)}");
