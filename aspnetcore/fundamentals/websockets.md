...
:::code language="csharp" source="websockets/samples/8.x/WebSocketsSample/Snippets/Program.cs" id="snippet_UseWebSockets":::
...
:::code language="csharp" source="websockets/samples/8.x/WebSocketsSample/Program.cs" id="snippet_UseWebSockets":::
...
:::code language="csharp" source="websockets/samples/8.x/WebSocketsSample/Snippets/Program.cs" id="snippet_AcceptWebSocketAsync" highlight="7":::
...
:::code language="csharp" source="websockets/samples/8.x/WebSocketsSample/Controllers/WebSocketController.cs" id="snippet_Controller_Connect":::
...
:::code language="csharp" source="websockets/samples/8.x/WebSocketsSample/Snippets/Program.cs" id="snippet_AcceptWebSocketAsyncBackgroundSocketProcessor":::
