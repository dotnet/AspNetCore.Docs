...
The following code generates the RDG002 warning because the route handler is provided as a reference to a static method:
...
:::code language="csharp" source="~/../AspNetCore.Docs.Samples/fundamentals/aot/diagonstics/Rdg2/Program.cs" id="snippet_1" highlight="13":::
