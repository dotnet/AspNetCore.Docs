...
:::code language="csharp" source="~/../AspNetCore.Docs.Samples/fundamentals/aot/diagnostics/Rdg7/Program.cs" id="snippet_1f" highlight="13-15,17-22":::


## When to suppress warnings

This warning cannot be safely suppressed. When suppressed, this will result in the runtime error `InvalidOperationException`.
