...
* Note: there is no replacement for the cookieless session feature from old ASP.NET Framework because it's considered insecure and can lead to session fixation attacks.
