...
Session is accessed through the `Session` property on `HttpContext`. This property is an [ISession](/dotnet/api/microsoft.aspnetcore.http.isession) implementation.
