...
![mermaid ASP.NET Core middleware pipeline](~/fundamentals/middleware/index/_static/middleware-pipeline.png)

The following diagram shows some of the middleware called in an ASP.NET Core app and a custom middleware:

![short mermaid ASP.NET Core middleware pipeline](~/fundamentals/middleware/index/_static/middleware-pipeline-short.png)
