...
| [Authorization](xref:Microsoft.AspNetCore.Builder.AuthorizationAppBuilderExtensions.UseAuthorization*) | Provides authorization support. | Before `HttpContext.User` is needed. Terminal for OAuth callbacks. |
