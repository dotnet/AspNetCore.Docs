...
The following `ConfigureServices` is generated by the Razor Pages template using individual user accounts:

[!code-csharp[](dependency-injection/samples/3.x/DependencyInjectionSample/StartupEF.cs?name=snippet)]

For more information, <xref:Microsoft.Extensions.DependencyInjection.ServiceCollection> and <xref:security/authentication/identity>.
...
When using Entity Framework Core, the [AddDbContext](/dotnet/api/microsoft.extensions.dependencyinjection.entityframeworkservicecollectionextensions.adddbcontext) extension method registers `DbContext` types with a scoped lifetime by default.
...
* <xref:Microsoft.Extensions.DependencyInjection.ActivatorUtilities>:
  * Permits object creation without service registration in the dependency injection container.
...
[!code-json[](dependency-injection/samples/3.x/DependencyInjectionSample/appsettings.Development.json)]
