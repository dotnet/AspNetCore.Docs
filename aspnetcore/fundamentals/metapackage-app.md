...
The `Microsoft.AspNetCore.App` [metapackage](https://github.com/dotnet/docs/blob/master/docs/core/packages.md#metapackages) is not a traditional package that is updated from NuGet. Similar to `Microsoft.NETCore.App`, `Microsoft.AspNetCore.App` represents a shared runtime, which has special versioning semantics handled outside of NuGet. For more information, see [Packages, metapackages and frameworks](https://github.com/dotnet/docs/blob/master/docs/core/packages.md).
