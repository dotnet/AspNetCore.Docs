...
app.MapGet("/singleFile", () => Results.Text(@"<!DOCTYPE html> <html> <head> <meta charset='utf-8'> 
</head> <body> <form action='/fileup' method='post' enctype='multipart/form-data'>
<input multiple name='formfile' type='file'>Swac <input type='submit'> </form>
</body> </html>", "text/html"));
...
app.MapPost("/fileup", async (IFormFile file) =>
{
    ...
    tempfile = $@"C:\tmp\{DateTime.Now.Ticks}.jpg";
