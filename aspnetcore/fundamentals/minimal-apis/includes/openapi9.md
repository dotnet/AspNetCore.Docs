...
:::code language="csharp" source="~/fundamentals/minimal-apis/9.0-samples/WebMinOpenApi/Program.cs" id="snippet_1" highlight="5,11,35":::

[!code-csharp[](~/fundamentals/minimal-apis/9.0-samples/WebMinOpenApi/Program.cs?highlight=5,11,35)]
...
* Support for generating OpenAPI documents at build-time and serializing them to disk
<!--
