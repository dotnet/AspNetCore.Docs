...
Minimal API apps can be configured to generate problem details response for all HTTP client and server error responses that **_don't have a body content yet_** by using the `AddProblemDetails` extension method.
