...
public class TodoTests
{
    ...
    public async Task GetTodoReturnsTodoFromDatabase()
    {
        ...
        mock.Setup(m => m.Find(It.Is<int>(id => id == 1))).ReturnsAsync(new Todo
        {
            Id = 1,
            Title = "Test title",
            IsDone = false
        ...
        mock.Setup(m => m.Find(It.Is<int>(id => id == 2))).ReturnsAsync((Todo?)null);
    ...
    public async Task UpdateTodoUpdatesTodoInDatabase()
    {
        ...
        mock.Setup(m => m.Find(It.Is<int>(id => id == 1))).ReturnsAsync(existingTodo);
    ...
    public async Task DeleteTodoDeletesTodoInDatabase()
    {
        ...
        mock.Setup(m => m.Find(It.Is<int>(id => id == existingTodo.Id))).ReturnsAsync(existingTodo);
