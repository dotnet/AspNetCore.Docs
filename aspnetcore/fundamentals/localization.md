...
Run the website and you should see something like this
   ...
   ![Show CultureInfo and formats](localization/_static/cultureinfoformats1.png)
...
````
   ...
   ![Show CultureInfo and formats](localization/_static/cultureinfoformats3.png)
...
we get some generic French formats when we request with `fr-CA`:
   ...
   ![Show CultureInfo and formats](localization/_static/cultureinfoformats4.png)
...
````
   ...
   ![Show CultureInfo and formats](localization/_static/cultureinfoformats5.png)
...
Language page navigated to
   ...
   ![cookie provider](localization/_static/cookieprovider2.png)

Redirect to Index with a new language set by the cookie

   ![cookie provider](localization/_static/cookieprovider3.png)
...
````
   ...
   ![Show translated strings, German culture](localization/_static/sharedlocalizer2.png)
...
*MyResources*. The structure would look like this:
   ...
   ![Resources in solution explorer](localization/_static/solutionexplorerprivacy2.png)
...
and another one named `Pages.Shared._Layout.fr-FR.resx`.
   ...
   ![Resources in solution explorer](localization/_static/solutionexplorerprivacy3.png)
...
Change language and try again. You should see something like this:
   ...
   ![Show data annotations](localization/_static/dataannotation2.png)
