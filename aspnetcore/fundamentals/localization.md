...
ASP.NET Core 1.0 doesn't look up localized strings for non-validation attributes. In the code above, "Email" (from `[Display(Name = "Email")]`) will not be localized. In ASP.NET Core 1.1.0 and higer, non-validation attributes are localized.
