...
The most common scenario for creating and using a physical file provider is to request an `IFileProvider` in a constructor through [dependency injection](xref:fundamentals/dependency-injection).
