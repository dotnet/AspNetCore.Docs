...
* Host with wildcard sub-domain: `*.domain.com` (matches`domain.com`, `www.domain.com`, `subdomain.domain.com`, or `www.subdomain.domain.com` on any port)
* Port: `*:5000` (matches port 5000)
