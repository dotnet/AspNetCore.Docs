...
|           Route                |             Formatter              |
|--------------------------------|------------------------------------|
|   `/api/products/GetById/5`    |    The default output formatter    |
| `/api/products/GetById/5.json` | The JSON formatter (if configured) |
| `/api/products/GetById/5.xml`  | The XML formatter (if configured)  |
