...
Shadow copy is supported in ASP.NET Core 7 and later. For more information, see [Shadow copy](host-and-deploy/iis/advanced?view=aspnetcore-7.0#shadow-copy).
