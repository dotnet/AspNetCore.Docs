...
Shadow copy is now in preview but will be supported when ASP.NET Core 7.0 is released. For more information, see [Shadow copy](xref:host-and-deploy/iis/advanced?view=aspnetcore-7.0&preserve-view=true#shadow-copy).
