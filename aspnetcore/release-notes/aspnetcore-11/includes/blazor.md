...
![Blazor AI chat interface showing a conversation with a travel planning agent](~/blazor/static/blazor-ai-chat.png)
...
![A generated typed tool block rendering a weather result](~/blazor/static/blazor-ai-tool-block.png)
...
![A tool call waiting for human approval](~/blazor/static/blazor-ai-tool-approval.png)
...
![Typed agent state rendered as a recipe card](~/blazor/static/blazor-ai-shared-state.png)
...
![An express shipping proposal with accept and reject actions](~/blazor/static/blazor-ai-predictive-state.png)
