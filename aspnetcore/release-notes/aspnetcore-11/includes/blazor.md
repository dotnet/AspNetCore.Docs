...
> [!IMPORTANT]
> The `Microsoft.AspNetCore.Components.AI` package is a prerelease, experimental package throughout .NET 11. For .NET 11 RC1, use version `0.1.0-preview.1.26459.102`.
...
![Blazor AI chat interface showing a conversation with a travel planning agent](~/release-notes/aspnetcore-11/_static/blazor-ai-chat.png)
...
![A generated typed tool block rendering a weather result](~/release-notes/aspnetcore-11/_static/blazor-ai-tool-block.png)
...
![A tool call waiting for human approval](~/release-notes/aspnetcore-11/_static/blazor-ai-tool-approval.png)
...
![Typed agent state rendered as a recipe card](~/release-notes/aspnetcore-11/_static/blazor-ai-shared-state.png)
...
![An express shipping proposal with accept and reject actions](~/release-notes/aspnetcore-11/_static/blazor-ai-predictive-state.png)
