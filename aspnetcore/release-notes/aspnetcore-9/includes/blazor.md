...
For more information, see the following sections of the [Secure ASP.NET Core server-side Blazor apps](xref:blazor/security/server/index?view=aspnetcore-9.0) article:
