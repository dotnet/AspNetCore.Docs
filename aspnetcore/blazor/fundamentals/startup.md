...
> [!NOTE]
> For a library to automatically execute additional tasks after Blazor has started, use a [JavaScript initializer](#javaScript-initializers). Use of a JS initializer doesn't require the consumer of the library chain JS calls to Blazor's manual start.
