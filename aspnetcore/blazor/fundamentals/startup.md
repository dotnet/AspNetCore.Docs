...
To disable [enhanced navigation and form handling](xref:blazor/fundamentals/environments/routing#enhanced-navigation-and-form-handling), set `disableDomPreservation` to `true` for `Blazor.start`.
