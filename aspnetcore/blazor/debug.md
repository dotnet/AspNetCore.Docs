...
| `url`     | The URL to open in the browser when debugging. Defaults to `https://localhost:5001`. Note, if your app is running at a different URL an `about:blank` will launch within the browser. |
