...
[!code-html[](samples_snapshot/index-script-convertarray.html)]
...
[!code-razor[](samples_snapshot/call-js-example.razor?highlight=2,34-35)]
...
* Inject the `IJSRuntime` abstraction into the Razor component (*.razor*):
  ...
  [!code-razor[](samples_snapshot/inject-abstraction.razor?highlight=1)]
  ...
  [!code-html[](samples_snapshot/index-script-handleTickerChanged1.html)]

* Inject the `IJSRuntime` abstraction into a class (*.cs*):

  [!code-csharp[](samples_snapshot/inject-abstraction-class.cs?highlight=5)]
  ...
  [!code-html[](samples_snapshot/index-script-handleTickerChanged2.html)]
...
[!code-razor[](samples_snapshot/component1.razor?highlight=1,3,11-12)]
...
[!code-razor[](samples_snapshot/component2.razor?highlight=1-4,12)]
...
[!code-razor[](samples_snapshot/component3.razor?highlight=17)]
