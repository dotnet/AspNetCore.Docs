...
1. Clone this repository or download a ZIP archive of the repository. For more information, see [How to download a sample](xref:fundamentals/overview#how-to-download-a-sample).
