...
[View or download sample code](https://github.com/dotnet/AspNetCore.Docs/tree/main/aspnetcore/5.0/blazor/samples/) ([how to download](xref:index#how-to-download-a-sample))
