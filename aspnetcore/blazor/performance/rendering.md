...
* Override [`ShouldRender`](xref:blazor/components/rendering#suppress-ui-refreshing-shouldrender):
  * When parameters receive nonprimitive values or unsupported primitive values&dagger;, such as complex custom model types or <xref:Microsoft.AspNetCore.Components.RenderFragment> values.
