...
* Routable components &ndash; For components that are directly routable from user requests.
...
* [Render components from a page or view](#render-components-from-a-page-or-view) &ndash; For components that aren't directly routable from user requests.
