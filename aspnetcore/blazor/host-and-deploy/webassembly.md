...
<!-- UPDATE 9.0 Remove the following CAUTION at 9.0 GA -->
...
CentOS, a Linux distribution, has reached End Of Life (EOL) status. For more information, see the following resources:
