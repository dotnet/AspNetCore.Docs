...
<xref:Microsoft.AspNetCore.Components.ParameterView> contains the set of parameter values set by the parent each time <xref:Microsoft.AspNetCore.Components.ComponentBase.SetParametersAsync%2A> is called.
