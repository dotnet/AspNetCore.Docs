...
* [Blazor Web App (search for `MainLayout.razor.css` in the server project)](https://github.com/dotnet/aspnetcore/tree/main/src/ProjectTemplates/Web.ProjectTemplates/content/BlazorWeb-CSharp)
