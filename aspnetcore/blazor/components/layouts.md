...
* [Blazor Server `MainLayout.razor.css`](https://github.com/dotnet/aspnetcore/blob/main/src/Components/WebAssembly/Samples/HostedBlazorWebassemblyApp/Client/Shared/MainLayout.razor.css)
