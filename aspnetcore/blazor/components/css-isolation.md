...
For example to add CSS isolation to the `Counter` component in a sample app created from the Blazor project template, add a new file named `Counter.razor.css`, then add the following CSS:
