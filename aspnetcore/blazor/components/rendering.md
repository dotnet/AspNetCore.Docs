...
Use *streaming rendering* with [server rendering](xref:blazor/components/render-modes) to stream content updates on the response stream and improve the user experience for components that perform long-running asynchronous tasks to fully render.
