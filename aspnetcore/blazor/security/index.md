...
* Content isn't found.
* The user fails an [`[Authorize]` attribute](xref:Microsoft.AspNetCore.Authorization.AuthorizeAttribute) condition applied to the component. The [`[Authorize]`](xref:Microsoft.AspNetCore.Authorization.AuthorizeAttribute) is covered in the [`[Authorize]` attribute](#authorize-attribute) section.
