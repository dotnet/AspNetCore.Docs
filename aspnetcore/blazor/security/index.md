...
The server project also maintains the backend web API to field weather data calls from the `ClientWeatherForecaster` service:
...
There are two systems in place to supply secure weather data to the user:
