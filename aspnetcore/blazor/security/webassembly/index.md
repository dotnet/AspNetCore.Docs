...
For more information on refresh token lifetime, see [Microsoft identity platform refresh tokens](/azure/active-directory/develop/refresh-tokens#refresh-token-lifetime).
