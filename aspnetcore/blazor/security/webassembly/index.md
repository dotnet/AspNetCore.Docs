...
Apply the [`[Authorize]` attribute](xref:blazor/security/index#authorize-attribute) ([API documentation](xref:System.Web.Mvc.AuthorizeAttribute)) to each Blazor component of the app using one of the following approaches:
...
* Add the attribute to each Blazor component in the `Pages` folder.
