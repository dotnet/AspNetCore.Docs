...
The list of claims in the ID token changes for v2.0 endpoints. For more information, see [Why update to Microsoft identity platform (v2.0)?](/entra/identity-platform/azuread-dev/azure-ad-endpoint-comparison).
