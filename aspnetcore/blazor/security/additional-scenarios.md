...
Usually, it's more convenient to place static assets for anonymous requests into a single folder. In the following example, endpoint routes with the `/public/` path segment are served anonymously:
