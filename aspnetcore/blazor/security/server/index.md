...
It looks like the BWA + OIDC sample apps will be adopting 
the new API. If so, I'll take care of that closer to 
release, probably in the RC time frame. Let me know if
