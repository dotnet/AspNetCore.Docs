...
To configure the server API app for a matching audience, set the `Audience` in the **:::no-loc text="Server":::** API app settings file (`appsettings.json`) to match the app's audience provided by the Azure portal:
...
Configure the **:::no-loc text="Server":::** API app settings file (`appsettings.json`) with a matching audience (`Audience`):
