...
## Cross-origin resource sharing (CORS) in Blazor Server
...
## Additional resources for Blazor Server
...
For guidance on how to create a server-side web API, see <xref:tutorials/first-web-api>. For information on Cross-origin resource sharing (CORS), see the [CORS guidance](#cross-origin-resource-sharing-cors-in-blazor-webassembly) later in this article.
...
## Cross-origin resource sharing (CORS) in Blazor WebAssembly
