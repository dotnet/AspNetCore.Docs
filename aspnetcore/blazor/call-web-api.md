...
> [!NOTE]
> This article has loaded **Blazor WebAssembly** coverage on this subject. The [Blazor Server coverage](?pivots=server) addresses the following subjects:
>
...
> [!NOTE]
> This article has loaded **Blazor Server** coverage on this subject. The [Blazor WebAssembly coverage](?pivots=webassembly) addresses the following subjects:
>
