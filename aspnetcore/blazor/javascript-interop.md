...
The built NuGet package is referenced in the project file of the app the same way that any NuGet package is referenced. After the app is restored, app code can call into JavaScript as if it were C#.
