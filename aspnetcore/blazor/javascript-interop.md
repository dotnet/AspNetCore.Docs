...
* Invoke the registered callbacks during the `OnAfterRender` event with the passed element reference. Indirectly, this approach allows the child components to interact with the parent's element reference.
