...
Visual Studio launches a terminal window and prints out the URL of the running application. The API is hosted at `https://localhost:<port>`, where `<port>` is a randomly chosen port number set at the project creation. 
