...
See the [completed SeedData.cs file](https://github.com/aspnet/Docs/blob/live/aspnetcore/tutorials/razor-pages/razor-pages-start/sample/RazorPagesMovie/Models/SeedDataRating.cs).
