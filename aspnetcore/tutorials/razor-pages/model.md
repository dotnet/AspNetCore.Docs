...
1. Complete the **Add Razor Pages using Entity Framework (CRUD)** dialog:
   ...
   If you get an error message that says you need to install the `Microsoft.EntityFrameworkCore.SqlServer` package, install the package and repeat the steps starting with **Add** > **New Scaffolded Item**.
