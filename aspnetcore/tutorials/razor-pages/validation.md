...
For information on deploying to Azure, see [Tutorial: Build an ASP.NET Core app in Azure with SQL Database](xref:/azure/app-service/tutorial-dotnetcore-sqldb-app).
