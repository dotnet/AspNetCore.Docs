...
* [App.razor](xref:blazor/routing#route-templates) &ndash; Maintains the `Router` component, which enables routing to the app's components. The `App` component is the root Razor component in the app and hosts the rest of the app's components.
