...
[!code-csharp[](~/tutorials/first-mvc-app/start-mvc/sample/mvcmovie10/Models/Movie.cs?name=snippet_Second&highlight=2,3,12,13,16)]
...
:::image type="content" source="~/tutorials/first-mvc-app/controller-methods-views/media/edit-movie-link.png" alt-text="Browser window with mouse over the Edit link and a link Url is shown on the window.":::

The **Edit**, **Details**, and **Delete** links are generated by the Core MVC Anchor Tag Helper in the `Views/Movies/Index.cshtml` file.

[!code-cshtml[](~/tutorials/first-mvc-app/start-mvc/sample/MvcMovie10/Views/Movies/IndexOriginal.cshtml?highlight=1-3&range=46-50)]
...
[!code-csharp[](~/tutorials/first-mvc-app/start-mvc/sample/MvcMovie10/Controllers/MoviesController.cs?name=snippet_EditGet)]
...
[!code-csharp[](~/tutorials/first-mvc-app/start-mvc/sample/MvcMovie10/Controllers/MoviesController.cs?name=snippet_EditPost&highlight=4)]
...
[!code-cshtml[](~/tutorials/first-mvc-app/start-mvc/sample/MvcMovie10/Views/Movies/EditOriginal.cshtml?range=13)]
...
[!code-cshtml[](~/tutorials/first-mvc-app/start-mvc/sample/MvcMovie10/Views/Movies/EditOriginal.cshtml)]
...
[!code-HTML[](~/tutorials/first-mvc-app/start-mvc/sample/MvcMovie10/Views/Shared/edit_view_source.html?highlight=1,6,10,17,24,28)]
...
[!code-csharp[](~/tutorials/first-mvc-app/start-mvc/sample/MvcMovie10/Controllers/MoviesController.cs?name=snippet_EditPost)]
...
:::image type="content" source="~/tutorials/first-mvc-app/controller-methods-views/media/edit-movie-validation.png" alt-text="Edit view: An exception for an incorrect Price value of abc states that The field Price must be a number. An exception for an incorrect Release Date value states Please enter a valid date.":::
...
[!INCLUDE[](~/tutorials/first-mvc-app/controller-methods-views/includes/controller-methods-views9.md)]
