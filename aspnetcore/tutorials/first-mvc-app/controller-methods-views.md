...
* Right click on a red squiggly line **> Quick Actions**.
  ...
  ![Contextual menu](controller-methods-views/_static/qa.png)
...
* Tap `using System.ComponentModel.DataAnnotations;`
  ...
  ![Contextual menu](controller-methods-views/_static/da.png)
...
![Contextual menu](controller-methods-views/_static/rm.png)
...
![Movies controller showing the Edit action method that takes an optional id parameter](controller-methods-views/_static/1.png)
