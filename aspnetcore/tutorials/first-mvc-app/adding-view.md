...
`ViewData["Title"] = "Movie List";` in the code above sets the `Title` property of the [`ViewDataDictionary`](ViewDataDictionary) to "Movie List". The `Title` property is used in the `<title>` HTML element in the layout page:
