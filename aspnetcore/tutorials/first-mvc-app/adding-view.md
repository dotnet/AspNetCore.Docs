...
Save the changes and select the **Privacy** link. Notice how the title on the browser tab displays :::no-loc text=" **Privacy Policy - Movie App** " ::: instead of :::no-loc text=" **Privacy Policy - MvcMovie** : " :::
