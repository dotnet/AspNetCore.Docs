...
In this section you install the Entity Framework Core tools by editing the *.csproj* file. You can't use the `install-package` command or the package manager GUI to install a tools package.
