...
Delete the database and the previous migration and use migrations to re-create the database. To delete the database, delete the *MvcMovie.db* database file. Then run the the following commands:
