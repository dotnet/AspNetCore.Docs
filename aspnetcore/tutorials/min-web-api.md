...
:::code language="csharp" source="~/tutorials/min-web-api/samples/TodoApi_VS_EndpointExplorer/Program.cs?name=snippet_templatestart":::

# [Visual Studio Code](#tab/visual-studio-code)

:::code language="csharp" source="~/tutorials/min-web-api/samples/10.x/TodoApi_VSC_Scalar/Program.cs?name=snippet_templatestart":::
...
:::code language="csharp" source="~/tutorials/min-web-api/samples/TodoApi_VS_EndpointExplorer/Todo.cs":::
...
* Create a file named `TodoDb.cs` with the following code:
 ...
 :::code language="csharp" source="~/tutorials/min-web-api/samples/TodoApi_VS_EndpointExplorer/TodoDb.cs":::
...
:::code language="csharp" source="~/tutorials/min-web-api/samples/TodoApi_VS_EndpointExplorer/Program.cs?name=snippet_minimal_start_all":::

# [Visual Studio Code](#tab/visual-studio-code)

:::code language="csharp" source="~/tutorials/min-web-api/samples/10.x/TodoApi_VSC_Scalar/Program.cs?name=snippet_minimal_start_all":::
...
[!code-csharp[](~/tutorials/min-web-api/samples/TodoApi_VS_EndpointExplorer/Program.cs?name=snippet_DI&highlight=2-3)]

# [Visual Studio Code](#tab/visual-studio-code)

[!code-csharp[](~/tutorials/min-web-api/samples/10.x/TodoApi_VSC_Scalar/Program.cs?name=snippet_DI&highlight=2-3)]
...
* In `Program.cs`, add the `using` directive and the highlighted `MapScalarApiReference` line inside the `if (app.Environment.IsDevelopment())` block, right after the `app.MapOpenApi();` line:
  ...
  [!code-csharp[](~/tutorials/min-web-api/samples/10.x/TodoApi_VSC_Scalar/Program.cs?name=snippet_scalar&highlight=4)]
...
[!code-csharp[](~/tutorials/min-web-api/samples/TodoApi_VS_EndpointExplorer/Program.cs?name=snippet_post)]

# [Visual Studio Code](#tab/visual-studio-code)

[!code-csharp[](~/tutorials/min-web-api/samples/10.x/TodoApi_VSC_Scalar/Program.cs?name=snippet_post)]
...
[!code-csharp[](~/tutorials/min-web-api/samples/TodoApi_VS_EndpointExplorer/Program.cs?name=snippet_get)]

# [Visual Studio Code](#tab/visual-studio-code)

[!code-csharp[](~/tutorials/min-web-api/samples/10.x/TodoApi_VSC_Scalar/Program.cs?name=snippet_get)]
...
[!code-csharp[](~/tutorials/min-web-api/samples/TodoApi_VS_EndpointExplorer/Program.cs?name=snippet_put)]

# [Visual Studio Code](#tab/visual-studio-code)

[!code-csharp[](~/tutorials/min-web-api/samples/10.x/TodoApi_VSC_Scalar/Program.cs?name=snippet_put)]
...
:::code language="csharp" source="~/tutorials/min-web-api/samples/TodoApi_VS_EndpointExplorer/TodoPatchDto.cs":::
...
[!code-csharp[](~/tutorials/min-web-api/samples/TodoApi_VS_EndpointExplorer/Program.cs?name=snippet_patch)]

# [Visual Studio Code](#tab/visual-studio-code)

[!code-csharp[](~/tutorials/min-web-api/samples/10.x/TodoApi_VSC_Scalar/Program.cs?name=snippet_patch)]
...
[!code-csharp[](~/tutorials/min-web-api/samples/TodoApi_VS_EndpointExplorer/Program.cs?name=snippet_delete)]

# [Visual Studio Code](#tab/visual-studio-code)

[!code-csharp[](~/tutorials/min-web-api/samples/10.x/TodoApi_VSC_Scalar/Program.cs?name=snippet_delete)]
...
:::code language="csharp" source="~/tutorials/min-web-api/samples/TodoApi_VS_EndpointExplorer/Program.cs" id="snippet_mapgroup_all":::

# [Visual Studio Code](#tab/visual-studio-code)

:::code language="csharp" source="~/tutorials/min-web-api/samples/10.x/TodoApi_VSC_Scalar/Program.cs" id="snippet_mapgroup_all":::
...
:::code language="csharp" source="~/tutorials/min-web-api/samples/TodoApi_VS_EndpointExplorer/Program.cs" id="snippet_typed_all":::

# [Visual Studio Code](#tab/visual-studio-code)

:::code language="csharp" source="~/tutorials/min-web-api/samples/10.x/TodoApi_VSC_Scalar/Program.cs" id="snippet_typed_all":::

---

The `Map<HttpVerb>` code now calls methods instead of lambdas:

:::code language="csharp" source="~/tutorials/min-web-api/samples/TodoApi_VS_EndpointExplorer/Program.cs" id="snippet_typed_group":::
...
:::code language="csharp" source="~/tutorials/min-web-api/samples/TodoApi_VS_EndpointExplorer/Program.cs" id="snippet_typed_handlers":::

Unit tests can call these methods and test that they return the correct type. For example, if the method is `GetAllTodos`:

:::code language="csharp" source="~/tutorials/min-web-api/samples/TodoApi_VS_EndpointExplorer/Program.cs" id="snippet_typed_getalltodos":::
...
:::code language="csharp" source="~/tutorials/min-web-api/samples/TodoApi_VS_EndpointExplorer/TodoItemDTO.cs":::

Replace the contents of the `Program.cs` file with the following code to use this DTO model:

# [Visual Studio](#tab/visual-studio)

:::code language="csharp" source="~/tutorials/min-web-api/samples/TodoApi_VS_EndpointExplorer/Program.cs" id="snippet_dto_all":::

# [Visual Studio Code](#tab/visual-studio-code)

:::code language="csharp" source="~/tutorials/min-web-api/samples/10.x/TodoApi_VSC_Scalar/Program.cs" id="snippet_dto_all":::
