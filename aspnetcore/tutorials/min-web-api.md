...
:::code language="csharp" source="~/tutorials/min-web-api/samples/10.x/TodoApi_VS_EndpointExplorer/Program.cs?name=snippet_templatestart":::
...
:::code language="csharp" source="~/tutorials/min-web-api/samples/10.x/TodoApi_VS_EndpointExplorer/Program.cs?name=snippet_minimal_start_all":::
...
[!code-csharp[](~/tutorials/min-web-api/samples/10.x/TodoApi_VS_EndpointExplorer/Program.cs?name=snippet_DI&highlight=2-3)]
...
[!code-csharp[](~/tutorials/min-web-api/samples/10.x/TodoApi_VS_EndpointExplorer/Program.cs?name=snippet_post)]
...
[!code-csharp[](~/tutorials/min-web-api/samples/10.x/TodoApi_VS_EndpointExplorer/Program.cs?name=snippet_get)]
...
[!code-csharp[](~/tutorials/min-web-api/samples/10.x/TodoApi_VS_EndpointExplorer/Program.cs?name=snippet_put)]
...
[!code-csharp[](~/tutorials/min-web-api/samples/10.x/TodoApi_VS_EndpointExplorer/Program.cs?name=snippet_patch)]
...
[!code-csharp[](~/tutorials/min-web-api/samples/10.x/TodoApi_VS_EndpointExplorer/Program.cs?name=snippet_delete)]
...
:::code language="csharp" source="~/tutorials/min-web-api/samples/10.x/TodoApi_VS_EndpointExplorer/Program.cs" id="snippet_mapgroup_all":::
...
:::code language="csharp" source="~/tutorials/min-web-api/samples/10.x/TodoApi_VS_EndpointExplorer/Program.cs" id="snippet_typed_all":::
...
:::code language="csharp" source="~/tutorials/min-web-api/samples/10.x/TodoApi_VS_EndpointExplorer/Program.cs" id="snippet_typed_getalltodos":::
...
:::code language="csharp" source="~/tutorials/min-web-api/samples/10.x/TodoApi_VS_EndpointExplorer/Program.cs" id="snippet_dto_all":::
