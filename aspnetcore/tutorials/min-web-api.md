...
* In the **Additional information** dialog:
   ...
   * **Uncheck** the checkbox for **Use controllers**. This checkbox is checked by default starting with Visual Studio 2026; uncheck it to create a Minimal API project instead of a controller-based one.
   * Select **Create**.
...
:::code language="csharp" source="~/tutorials/min-web-api/samples/10.x/SnippetsTutorialReferenceOnly/Program-default-before-replacing.cs":::
...
[!code-csharp[](~/tutorials/min-web-api/samples/10.x/todo/Program.cs?name=snippet_all)]
