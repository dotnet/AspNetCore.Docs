...
![VS new project dialog](min-web-api/_static/vs3.png)
...
---
  ...
  [!code-csharp[](min-web-api/samples/3.0/TodoApi/Models/TodoItem.cs?name=snippet)]
...
![NuGet Package Manager](min-web-api/_static/vs3NuGet.png)
...
* Enter the following code:
  ...
  [!code-csharp[](min-web-api/samples/3.0/TodoApi/Models/TodoContext.cs)]
...
[!code-csharp[](min-web-api/samples/3.0/TodoApi/Startup.cs?highlight=7-8,23-24&name=snippet_all)]
...
[!code-csharp[](min-web-api/samples/3.0/TodoApi/Controllers/TodoItemsController.cs?name=snippet_Create)]
...
* Copy the **Location** header value:
  ...
  ![Headers tab of the Postman console](min-web-api/_static/3/create.png)

* Set the HTTP method to `GET`.
* Set the URI to `https://localhost:<port>/TodoItems/1`. For example, `https://localhost:5001/TodoItems/1`.
* Select **Send**.
...
* Start with the template string in the controller's `Route` attribute:
  ...
  [!code-csharp[](min-web-api/samples/3.0/TodoApi/Controllers/TodoItemsController.cs?name=TodoController&highlight=1)]
...
[!code-csharp[](min-web-api/samples/3.0/TodoApi/Controllers/TodoItemsController.cs?name=snippet_GetByID&highlight=1-2)]
...
[!code-csharp[](min-web-api/samples/3.0/TodoApi/Controllers/TodoItemsController.cs?name=snippet_Update)]
...
[!code-csharp[](min-web-api/samples/3.0/TodoApi/Controllers/TodoItemsController.cs?name=snippet_Delete)]
...
[!code-csharp[](min-web-api/samples/3.0/TodoApiDTO/Models/TodoItem.cs?name=snippet&highlight=6)]
...
[!code-csharp[](min-web-api/samples/3.0/TodoApiDTO/Models/TodoItemDTO.cs?name=snippet)]

Update the `TodoItemsController` to use `TodoItemDTO`:

[!code-csharp[](min-web-api/samples/3.0/TodoApiDTO/Controllers/TodoItemsController.cs?name=snippet)]
...
![VS new project dialog](min-web-api/_static/vs.png)
...
Press Ctrl+F5 to run the app. Visual Studio launches a browser and navigates to `https://localhost:<port>/values`, where `<port>` is a randomly chosen port number.

If you get a dialog box that asks if you should trust the IIS Express certificate, select **Yes**. In the **Security Warning** dialog that appears next, select **Yes**.

# [Visual Studio Code](#tab/visual-studio-code)

Press Ctrl+F5 to run the app. In a browser, go to following URL: `https://localhost:5001/values`.

# [Visual Studio for Mac](#tab/visual-studio-mac)

Select **Run** > **Start Debugging** to launch the app. Visual Studio for Mac launches a browser and navigates to `https://localhost:<port>`, where `<port>` is a randomly chosen port number. An HTTP 404 (Not Found) error is returned. Append `/values` to the URL (change the URL to `https://localhost:<port>/values`).
...
---
  ...
  [!code-csharp[](min-web-api/samples/2.2/TodoApi/Models/TodoItem.cs)]
...
* Replace the template code with the following code:
  ...
  [!code-csharp[](min-web-api/samples/2.2/TodoApi/Models/TodoContext.cs)]
...
[!code-csharp[](min-web-api/samples/2.2/TodoApi/Startup1.cs?highlight=5,8,25-26&name=snippet_all)]
...
* Name the class *TodoController*, and select **Add**.
  ...
  ![Add new Item dialog with controller in search box and web api controller selected](min-web-api/_static/new_controller.png)
...
* Replace the template code with the following code:
  ...
  [!code-csharp[](min-web-api/samples/2.2/TodoApi/Controllers/TodoController2.cs?name=snippet_todo1)]
...
[!code-csharp[](min-web-api/samples/2.2/TodoApi/Controllers/TodoController.cs?name=snippet_GetAll)]
...
* `https://localhost:<port>/todo`
* `https://localhost:<port>/todo/1`
...
* Start with the template string in the controller's `Route` attribute:
  ...
  [!code-csharp[](min-web-api/samples/2.2/TodoApi/Controllers/TodoController.cs?name=TodoController&highlight=3)]
...
[!code-csharp[](min-web-api/samples/2.2/TodoApi/Controllers/TodoController.cs?name=snippet_GetByID&highlight=1-2)]
...
* Create a new request.
  * Set the HTTP method to **GET**.
  * Set the request URI to `https://localhost:<port>/todo`. For example, `https://localhost:5001/todo`.
* Set **Two pane view** in Postman.
* Select **Send**.

![Postman with Get request](min-web-api/_static/2pv.png)

## Add a Create method 2.1

Add the following `PostTodoItem` method inside of *Controllers/TodoController.cs*: 

[!code-csharp[](min-web-api/samples/2.2/TodoApi/Controllers/TodoController.cs?name=snippet_Create)]
...
* Set the URI to `https://localhost:<port>/Todo`. For example, `https://localhost:5001/Todo`.
* Select the **Body** tab.
* Select the **raw** radio button.
* Set the type to **JSON (application/json)**.
* In the request body enter JSON for a to-do item:
...
* Select **Send**.
  ...
  ![Postman with create request](min-web-api/_static/create.png)
...
* Copy the **Location** header value:
  ...
  ![Headers tab of the Postman console](min-web-api/_static/pmc2.png)

* Set the method to GET.
* Set the URI to `https://localhost:<port>/TodoItems/2`. For example, `https://localhost:5001/TodoItems/2`.
* Select **Send**.
...
[!code-csharp[](min-web-api/samples/2.2/TodoApi/Controllers/TodoController.cs?name=snippet_Update)]
...
![Postman console showing 204 (No Content) response](min-web-api/_static/pmcput.png)

## Add a DeleteTodoItem method 2.1

Add the following `DeleteTodoItem` method:

[!code-csharp[](min-web-api/samples/2.2/TodoApi/Controllers/TodoController.cs?name=snippet_Delete)]
...
* Set the method to `DELETE`.
* Set the URI of the object to delete (for example, `https://localhost:5001/todo/1`).
* Select **Send**.
...
[!code-csharp[](min-web-api/samples/2.2/TodoApi/Startup.cs?highlight=14-15&name=snippet_configure)]
...
[!code-html[](min-web-api/samples/2.2/TodoApi/wwwroot/index.html)]

Add a JavaScript file named *site.js* to the *wwwroot* directory. Replace its contents with the following code:

[!code-javascript[](min-web-api/samples/2.2/TodoApi/wwwroot/site.js?name=snippet_SiteJs)]
...
[!code-javascript[](min-web-api/samples/2.2/TodoApi/wwwroot/site.js?name=snippet_GetData)]
...
[!code-javascript[](min-web-api/samples/2.2/TodoApi/wwwroot/site.js?name=snippet_AddItem)]
...
[!code-javascript[](min-web-api/samples/2.2/TodoApi/wwwroot/site.js?name=snippet_AjaxPut)]
...
[!code-javascript[](min-web-api/samples/2.2/TodoApi/wwwroot/site.js?name=snippet_AjaxDelete)]
...
[View or download sample code for this tutorial](https://github.com/dotnet/AspNetCore.Docs/tree/main/aspnetcore/tutorials/min-web-api/samples). See [how to download](xref:index#how-to-download-a-sample).
