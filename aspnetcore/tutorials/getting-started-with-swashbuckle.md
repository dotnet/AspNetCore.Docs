...
~/tutorials/get-started-with-swashbuckle/
:::code language="csharp" source="~/tutorials/getting-started-with-swashbuckler/samples/6.x/SwashbuckleSample/Snippets/Program.cs" id="snippet_ServicesDefault" highlight="4":::
...
:::code language="csharp" source="~/tutorials/getting-started-with-swashbuckler/samples/6.x/SwashbuckleSample/Program.cs" id="snippet_Middleware" highlight="3,4":::
...
>
> :::code language="csharp" source="~/tutorials/getting-started-with-swashbuckler/samples/6.x/SwashbuckleSample/Snippets/Program.cs" id="snippet_MiddlewareRoutePrefix" highlight="6":::
...
>
> :::code language="csharp" source="~/tutorials/getting-started-with-swashbuckler/samples/6.x/SwashbuckleSample/Snippets/Program.cs" id="snippet_MiddlewareJsonV2" highlight="3":::
...
\
:::code language="csharp" source="~/tutorials/getting-started-with-swashbuckler/samples/6.x/SwashbuckleSample/Program.cs" id="snippet_UsingOpenApiModels":::

Using the `OpenApiInfo` class, modify the information displayed in the UI:

:::code language="csharp" source="~/tutorials/getting-started-with-swashbuckler/samples/6.x/SwashbuckleSample/Snippets/Program.cs" id="snippet_ServicesOpenApiInfo" highlight="3-19":::

The Swagger UI displays the version's information:

:::image source="~/tutorials/getting-started-with-swashbuckler/_static/v6-swagger-info.png" alt-text="Swagger UI with version information: description, author, and license.":::
...
:::code language="xml" source="~/tutorials/getting-started-with-swashbuckler/samples/6.x/SwashbuckleSample/SwashbuckleSample.csproj" range="9-12" highlight="3":::
...
:::code language="csharp" source="~/tutorials/getting-started-with-swashbuckler/samples/6.x/SwashbuckleSample/Models/TodoContext.cs" id="snippet_PragmaWarningDisable" highlight="3,10":::
...
:::code language="csharp" source="~/tutorials/getting-started-with-swashbuckler/samples/6.x/SwashbuckleSample/Program.cs" id="snippet_Services" highlight="22-23":::
...
:::code language="csharp" source="~/tutorials/getting-started-with-swashbuckler/samples/6.x/SwashbuckleSample/Controllers/TodoController.cs" id="snippet_Delete" highlight="1-3":::

The Swagger UI displays the inner text of the preceding code's `<summary>` element:

:::image source="~/tutorials/getting-started-with-swashbuckler/_static/v6-swagger-delete-summary.png" alt-text="Swagger UI showing XML comment 'Deletes a specific TodoItem.' for the DELETE method.":::

The UI is driven by the generated JSON schema:

:::code language="json" source="~/tutorials/getting-started-with-swashbuckler/_static/v6-swagger-delete.json" range="2-24":::
...
:::code language="csharp" source="~/tutorials/getting-started-with-swashbuckler/samples/6.x/SwashbuckleSample/Controllers/TodoController.cs" id="snippet_Create" highlight="6-16":::

Notice the UI enhancements with these additional comments:

:::image source="~/tutorials/getting-started-with-swashbuckler/_static/v6-swagger-post-remarks.png" alt-text="Swagger UI with additional comments shown.":::
...
:::code language="csharp" source="~/tutorials/getting-started-with-swashbuckler/samples/6.x/SwashbuckleSample/Models/TodoItem.cs" highlight="10":::

The presence of this attribute changes the UI behavior and alters the underlying JSON schema:

:::code language="json" source="~/tutorials/getting-started-with-swashbuckler/_static/v6-swagger-schemas-todoitem.json" range="2-23" highlight="3-5":::
...
:::code language="csharp" source="~/tutorials/getting-started-with-swashbuckler/samples/6.x/SwashbuckleSample/Controllers/TodoController.cs" id="snippet_ClassDeclaration" highlight="3":::

The **Media type** drop-down selects this content type as the default for the controller's GET actions:

:::image source="~/tutorials/getting-started-with-swashbuckler/_static/v6-swagger-get-media-type.png" alt-text="Swagger UI with default response content type":::
...
:::code language="csharp" source="~/tutorials/getting-started-with-swashbuckler/samples/6.x/SwashbuckleSample/Controllers/TodoController.cs" id="snippet_Create" highlight="17-18,20-21":::

The Swagger UI now clearly documents the expected HTTP response codes:

:::image source="~/tutorials/getting-started-with-swashbuckler/_static/v6-swagger-post-responses.png"  alt-text="Swagger UI showing POST Response Class description 'Returns the newly created Todo item' and '400 - If the item is null' for status code and reason under Response Messages.":::
...
[!INCLUDE[](~/tutorials/get-started-with-swashbuckle/includes/getting-started-with-swashbuckle8.md)]
