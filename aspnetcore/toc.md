...
#### [Working with SQL Server LocalDB](tutorials/first-mvc-app-mac/working-with-sql.md)
...
#### [Working with SQL Server LocalDB](tutorials/first-mvc-app-xplat/working-with-sql.md)
