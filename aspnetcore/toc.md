...
## [Create a Web API with ASP.NET Core and VS for Windows](xref:tutorials/first-web-api)
## [Create a Web API with ASP.NET Core and VS Code](xref:tutorials/web-api-vsc)
