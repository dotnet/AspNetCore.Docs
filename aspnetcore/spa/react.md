...
> [!NOTE]
> The existing .NET Core 2.0.x SDK includes a React project template. **This documentation is not about the existing React project template.** This documentation is about the next version of the React template which ships in early 2018.
