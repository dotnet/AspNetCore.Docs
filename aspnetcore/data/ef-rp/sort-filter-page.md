...
[!code-csharp[Main](intro/samples/cu30snapshots/3-sorting/Pages/Students/Index1.cshtml.cs?name=snippet1&highlight=10-13)]

Change the name of the `Student` property to `Students`:

[!code-csharp[Main](intro/samples/cu30snapshots/3-sorting/Pages/Students/Index1.cshtml.cs?name=snippet2)]

Replace the `OnGetAsync` method with the following code:

[!code-csharp[Main](intro/samples/cu30snapshots/3-sorting/Index1.cshtml.cs?name=snippet_SortOnly)]
...
[!code-csharp[Main](intro/samples/cu30snapshots/3-sorting/Index1.cshtml.cs?name=snippet_SortOnly&highlight=3-4)]
...
[!code-csharp[Main](intro/samples/cu30snapshots/3-sorting/Index1.cshtml.cs?name=snippet_SortOnly&highlight=6-25)]
...
[!code-csharp[Main](intro/samples/cu30snapshots/3-sorting/Index1.cshtml.cs?name=snippet_SortOnlyRtn)]
...
[!code-cshtml[Main](intro/samples/cu30snapshots/Index1.cshtml?highlight=17-19,25-27)]
...
[!code-csharp[Main](intro/samples/cu30snapshots/3-sorting/Pages/Students/Index2.cshtml.cs?name=snippet_SortFilter&highlight=1,5,9-13)]
...
[!code-csharp[Main](intro/samples/cu30/Pages/Students/Index.cshtml.cs?name=snippet_SortFilterPage2)]
...
[!code-csharp[Main](intro/samples/cu30/Pages/Students/Index.cshtml.cs?name=snippet_SortFilterPage3)]
...
[!code-csharp[Main](intro/samples/cu30/Pages/Students/Index3.cshtml.cs?name=snippet_SortFilterPage4)]
...
In this step, *Pages/About.cshtml* is created to display how many students have enrolled for each enrollment date. The update uses grouping and includes the following steps:
...
[!code-csharp[](intro/samples/cu30/Pages/Students/Index.cshtml.cs?name=snippet1&highlight=10-13)]

Update the *Students/Index.cshtml.cs* `OnGetAsync` with the following code:

[!code-csharp[](intro/samples/cu30/Pages/Students/Index.cshtml.cs?name=snippet_SortOnly)]
...
[!code-csharp[](intro/samples/cu30/Pages/Students/Index.cshtml.cs?name=snippet_SortOnly&highlight=3-4)]

The following code contains the C# conditional [?: operator](/dotnet/csharp/language-reference/operators/conditional-operator):

[!code-csharp[](intro/samples/cu30/Pages/Students/Index.cshtml.cs?name=snippet_Ternary)]
...
[!code-csharp[](intro/samples/cu30/Pages/Students/Index.cshtml.cs?name=snippet_SortOnly&highlight=6-999)]

 When an`IQueryable` is created or modified, no query is sent to the database. The query isn't executed until the `IQueryable` object is converted into a collection. `IQueryable` are converted to a collection by calling a method such as `ToListAsync`. Therefore, the `IQueryable` code results in a single query that's not executed until the following statement:

[!code-csharp[](intro/samples/cu30/Pages/Students/Index.cshtml.cs?name=snippet_SortOnlyRtn)]
...
[!code-html[](intro/samples/cu30/Pages/Students/Index2.cshtml?highlight=17-19,25-27)]
...
[!code-csharp[](intro/samples/cu30/Pages/Students/Index.cshtml.cs?name=snippet_SortFilter&highlight=1,5,9-13)]
...
[!code-html[](intro/samples/cu30/Pages/Students/Index3.cshtml?highlight=14-23&range=1-25)]
...
[!code-csharp[](intro/samples/cu30/PaginatedList.cs)]
...
[!code-csharp[](intro/samples/cu30/Pages/Students/Index.cshtml.cs?name=snippet_SortFilterPageType)]

Update the *Students/Index.cshtml.cs* `OnGetAsync` with the following code:

[!code-csharp[](intro/samples/cu30/Pages/Students/Index.cshtml.cs?name=snippet_SortFilterPage&highlight=1-4,7-14,41-999)]

The preceding code adds the page index, the current `sortOrder`, and the `currentFilter` to the method signature.

[!code-csharp[](intro/samples/cu30/Pages/Students/Index.cshtml.cs?name=snippet_SortFilterPage2)]
...
[!code-csharp[](intro/samples/cu30/Pages/Students/Index.cshtml.cs?name=snippet_SortFilterPage3)]

The `PaginatedList.CreateAsync` method converts the student query to a single page of students in a collection type that supports paging. That single page of students is passed to the Razor Page.

[!code-csharp[](intro/samples/cu30/Pages/Students/Index.cshtml.cs?name=snippet_SortFilterPage4)]
...
[!code-html[](intro/samples/cu30/Pages/Students/Index.cshtml?highlight=28-31,37-40,68-999)]

The column header links use the query string to pass the current search string to the `OnGetAsync` method so that the user can sort within filter results:

[!code-html[](intro/samples/cu30/Pages/Students/Index.cshtml?range=28-31)]

The paging buttons are displayed by tag helpers:

[!code-html[](intro/samples/cu30/Pages/Students/Index.cshtml?range=72-)]
...
[!code-csharp[](intro/samples/cu30/Models/SchoolViewModels/EnrollmentDateGroup.cs)]
...
[!code-csharp[](intro/samples/cu30/Pages/About.cshtml.cs)]
...
[!code-html[](intro/samples/cu30/Pages/About.cshtml)]
