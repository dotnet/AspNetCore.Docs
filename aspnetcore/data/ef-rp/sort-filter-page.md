...
If you run into problems you can't solve, download the [completed app for this stage](https://github.com/aspnet/Docs/tree/live/aspnetcore/data/ef-rp/intro/samples/StageSnapShots/cu-part3-sorting).
