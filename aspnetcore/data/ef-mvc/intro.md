...
> [!NOTE]
> For the Visual Studio 2015 version of this tutorial, see the [PDF of ASP.NET Core documentation as it was before the Visual Studio 2017 update](https://github.com/aspnet/Docs/blob/master/aspnetcore/common/_static/aspnet-core-project-json.pdf).
