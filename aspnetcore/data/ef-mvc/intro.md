...
This tutorial has **not** been updated to ASP.NET Core 3.0. The [Razor Pages](xref:data/ef-rp/intro) has been updated. For information on when this might be updates, see [this GitHub issue](https://github.com/aspnet/AspNetCore.Docs/issues/13920).
