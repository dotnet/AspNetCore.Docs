...
By [Tom Dykstra](https://github.com/tdykstra), [Rick Anderson](https://twitter.com/RickAndMSFT) and [Damien Bowden](https://twitter.com/damien_bod)
...
Open Visual Studio 2017 and create a new ASP.NET Core C# web project named "ContosoUniversity".
...
* The package for the EF command-line tools:   [Microsoft.EntityFrameworkCore.Tools](https://www.nuget.org/packages/Microsoft.EntityFrameworkCore.Tools/1.1.0-msbuild3-final). This package is a preview release, so to install it you have to enable preview release installation. After installing the package, you also have to add a reference to it in the `tools` collection in the *ContosoUniversity.csproj* file.

If you open the *ContosoUniversity.csproj* file, you'll see that these packages are already installed.

[!code-json[](intro/samples/cu/ContosoUniversity.csproj?highlight=7-11,16)]
