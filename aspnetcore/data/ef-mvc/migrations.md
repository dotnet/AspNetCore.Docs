...
If you see an error message "*cannot access the file ... ContosoUniversity.dll because it's being used by another process.*", find the IIS Express icon in the Windows System Tray, and right-click it, then click **ContosoUniversity > Stop Site**.
