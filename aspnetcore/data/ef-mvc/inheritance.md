...
[!TIP] Consider saving a copy of the project before making the following changes.  Then if you run into problems and need to start over, you can restart at the previous tutorial instead of having to go back to the beginning of the whole series.
