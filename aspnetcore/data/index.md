---
title: Worke with data in ASP.NET Core
...
uid: data/index
---
# Worke with data in ASP.NET Core
...
*   [Azure Storage](azure-storage/index.md)
    ...
    *   [Get started with Azure Table Storage and Visual Studio Connected Services](https://azure.microsoft.com/documentation/articles/vs-storage-aspnet5-getting-started-tables/)
