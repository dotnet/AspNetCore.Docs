...
AngularJS is not a DOM manipulation library like jQuery, but it uses a subset of jQuery called jQLite. AngularJS is primarily based on declarative HTML attributes that you can add to your HTML tags. You can try AngularJS in your browser using the [W3Schools website](https://www.w3schools.com/angular/) or [W3Schools website](https://www.w3schools.com/angular/).
