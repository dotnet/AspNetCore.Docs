...
1. **Development**: includes source maps for easy debugging and doesn't optimize client-side code for performance
1. **Production**: excludes source maps and optimizes the client-side code via bundling & minification
