...
By sharing the `*.proto` file between the server and client, messages and client code can be generated from end to end. This sharing eliminates duplication when building clients and can be a significant time saver.
