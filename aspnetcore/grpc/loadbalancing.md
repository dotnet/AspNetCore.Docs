...
| -------- | ----------------------- | ----------- |
| `dns`    | `DnsResolverFactory`    | Resolves addresses by querying the hostname for [DNS A/AAAA address records]([https://en.wikipedia.org/wiki/SRV_record](https://en.wikipedia.org/wiki/List_of_DNS_record_types#A)). |
