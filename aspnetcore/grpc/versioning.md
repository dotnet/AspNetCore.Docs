...
* **Nesting or unnesting a message** - Changing how a message type is [nested](https://developers.google.com/protocol-buffers/docs/proto3#nested) will change its message name. It has the same impact on compatibilty as renaming.
