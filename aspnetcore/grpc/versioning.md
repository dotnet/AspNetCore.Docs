...
* **Nesting or unnesting a message** - Changing how a message type is [nested](https://developers.google.com/protocol-buffers/docs/proto3#nested) changes its message name. Changing how a message type is nested has the same impact on compatibility as renaming.
