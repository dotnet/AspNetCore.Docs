...
* Ensures the shortest deadline is used when multiple is available. This can happen if a deadline is propogated to the child call ***and*** the child call specifies its own deadline.
