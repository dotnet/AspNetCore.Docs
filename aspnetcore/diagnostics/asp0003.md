...
Route handler endpoints only support a subset of MVC attributes such as [<xref:Microsoft.AspNetCore.Mvc.FromRouteAttribute>], [<xref:Microsoft.AspNetCore.Mvc.FromBodyAttribute>] etc. Unsupported attributes will be ignored and result in unexpected binding behavior. For example, the following code will result in an analyzer warning.
