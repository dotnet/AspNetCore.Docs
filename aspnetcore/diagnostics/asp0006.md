...
To fix a violation of this rule, make sure that calls to methods on the <xref:Microsoft.AspNetCore.Components.Rendering.RenderTreeBuilder> class that takes a sequence number as a parameter uses a literal sequence number.
