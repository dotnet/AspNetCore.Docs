...
For a reference guide to migrating ASP.NET 4.x apps to ASP.NET Core, see <xref:migration/fx-to-corex/index>.
...
For a reference guide to migrating ASP.NET apps to ASP.NET Core, see <xref:migration/fx-to-corex/index>.
