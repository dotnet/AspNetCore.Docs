There are also certain sets of keywords that ASP.NET Core MVC uses internally, which should be avoided in user-code as it can result in unexpected outcomes in certain scenarios.
