...
>
> An opt-in fix for this bug is contained in [.NET Core 3.1.301 SDK or later](https://dotnet.microsoft.com/download/dotnet-core/3.1). The following code sets an internal switch that fixes this bug:
>
>```csharp
