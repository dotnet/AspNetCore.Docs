...
>
> ASP.NET Core 3.0 has not yet been deployed to Azure App Service. We hope to provide ASP.NET Core 3 on Azure Apss Service soon. To host an app that uses an ASP.NET Core 3.0:
