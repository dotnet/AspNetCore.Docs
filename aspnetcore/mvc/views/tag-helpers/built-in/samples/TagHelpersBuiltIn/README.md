...
This sample illustrates the use of the built-in Anchor and Partial Tag Helpers with both MVC and Razor Pages. This sample demonstrates the features described in the following topics:
- [Anchor Tag Helper](https://docs.microsoft.com/aspnet/core/mvc/views/tag-helpers/built-in/anchor-tag-helper)
- [Partial Tag Helper](https://docs.microsoft.com/aspnet/core/mvc/views/tag-helpers/built-in/partial-tag-helper)

## Examples in this sample app
