...
The following markup uses the [Partial Tag Helper](xref:mvc/views/tag-helpers/built-in/partial-tag-helper) to render  *_ValidationScriptsPartial.cshtml*:
...
The preceding markup was generated by [scaffolding Identity](security/authentication/scaffold-identity).
