...
To specify a page route, add route segments, or add parameters to a route, use the page's `@page` directive. For more information, see the [Custom routes](xref:mvc/razor-pages/index#custom-routes).
