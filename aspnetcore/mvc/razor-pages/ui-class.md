...
* Name the library (ex. "RazorClassLib") > **OK**. _(Ensure this name does not end in `.Views` to avoid a filename collision with the generated view library.)_
...
For more information, see [dotnet new](/dotnet/core/tools/dotnet-new). _(Ensure this name does not end in `.Views` to avoid a filename collision with the generated view library.)_
