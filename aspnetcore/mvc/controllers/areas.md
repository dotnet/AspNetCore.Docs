...
* [View or download sample code](https://github.com/dotnet/AspNetCore.Docs/tree/main/aspnetcore/mvc/controllers/areas/60samples) ([how to download](xref:fundamentals/overview#how-to-download-a-sample)). The download sample provides a basic app for testing areas.
...
[View or download sample code](https://github.com/dotnet/AspNetCore.Docs/tree/main/aspnetcore/mvc/controllers/areas/31samples) ([how to download](xref:fundamentals/overview#how-to-download-a-sample)). The download sample provides a basic app for testing areas.
...
[View or download sample code](https://github.com/dotnet/AspNetCore.Docs/tree/main/aspnetcore/mvc/controllers/areas/samples) ([how to download](xref:fundamentals/overview#how-to-download-a-sample)). The download sample provides a basic app for testing areas.
