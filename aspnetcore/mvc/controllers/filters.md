...
:::code language="csharp" source="filters/samples/6.0/FiltersSample/Snippets/Filters/SampleActionFilter.cs" id="snippet_Class":::
...
:::code language="csharp" source="filters/samples/6.0/FiltersSample/Snippets/Filters/SampleAsyncActionFilter.cs" id="snippet_Class":::
...
:::code language="csharp" source="filters/samples/6.0/FiltersSample/Snippets/Program.cs" id="snippet_AddFilter":::
