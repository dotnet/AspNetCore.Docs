...
Complex segments ( `[Route("/r{token}z")]` ) are processed by matching up literals from right to left in a non-greedy way. See the [source code](https://github.com/aspnet/Routing/blob/9cea167cfac36cf034dbb780e3f783114ef94780/src/Microsoft.AspNetCore.Routing/Patterns/RoutePatternMatcher.cs#L289) for a detailed description.