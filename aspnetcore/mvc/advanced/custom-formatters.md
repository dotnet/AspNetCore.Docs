...
[View or download sample from GitHub](https://github.com/aspnet/Docs/tree/live/aspnetcore/mvc/advanced/custom-formatters/sample).
...
See the [sample application](https://github.com/aspnet/Docs/tree/live/aspnetcore/mvc/advanced/custom-formatters/sample), which implements simple vCard input and output formatters.  The application reads and writes vCards that look like the following example:
