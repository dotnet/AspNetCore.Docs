...
One approach is to create an IIS sub-application and only move certain routes from ASP.NET Framework to ASP.NET Core while preserving the URL structure the app. For example, consider the relevant section from the *applicationHost.config* file:
