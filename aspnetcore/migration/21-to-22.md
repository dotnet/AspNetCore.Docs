...
If the app doesn't call `CreateDefaultBuilder` and builds the host manually, call <xref:Microsoft.AspNetCore.Hosting.WebHostBuilderKestrelExtensions.UseKestrel*> **before** calling `ConfigureKestrel`:
