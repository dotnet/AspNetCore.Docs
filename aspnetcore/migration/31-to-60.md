...
To use `Startup` with the new minimal hosting model, see [Use Startup with the new minimal hosting model](xref:migration/50-to-60#use-a-startup-class-with-the-new-minimal-hosting-model).
