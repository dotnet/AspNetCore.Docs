...
**For smaller applications:** [Upgrade Assistant](xref:migration/fx-to-core/tooling) has an option for in-place upgrades. This works for small applications, but can quickly become unwieldy for larger projects.
