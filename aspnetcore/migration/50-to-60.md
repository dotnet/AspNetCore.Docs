...
description: Learn how to migrate an ASP.NET Core 5.0 project to ASP.NET Core in .NET 6.
ms.author: riande
...
This article explains how to update an existing ASP.NET Core 5.0 project to ASP.NET Core in .NET 6. For instructions on how to migrate from ASP.NET Core 3.1 to ASP.NET Core in .NET 6, see <xref:migration/31-to-60>.
