...
Custom DI containers are supported. See the Cheatsheet for an example.

### Does WebApplicationFactory and TestServer still work

`WebApplicationFactory<TEntryPoint>` is the way to test the new hosting model. See the xxz for an example.
