...
Update Blazor apps that target the ASP.NET Core 5.0 shared framework and runtime following the guidance earlier in this article:

* Update the app's [Target Framework Moniker (TFM)](/dotnet/standard/frameworks) to `net6.0`.
* Update the app's package reference versions to 6.0.0.
