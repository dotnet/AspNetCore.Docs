...
* Move the 5.0 app's components and code to the 6.0 app with any required modifications to adopt new 6.0 features.
...
Learn about breaking and non-breaking changes for ASP.NET Core apps, including for Blazor apps, at the [Announcements GitHub repository](https://github.com/aspnet/Announcements/issues?q=is%3Aissue+label%3A6.0.0+is%3Aopen).
