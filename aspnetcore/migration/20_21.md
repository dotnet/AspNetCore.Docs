...
## Packages or Projects targeting the shared runtime with Mvc.

These are the very specific rules for being able to use packages or projects targeting the shared runtime with Mvc.

* Project referencing Microsoft.AspNetCore.All or Microsoft.AspNetCore.App packages, must reference Microsoft.Net.Sdk.Web Sdk.
* Projects referencing packages or projects that transitively reference Microsoft.AspNetCore.All or Microsoft.AspNetCore.App must       reference Microsoft.Net.Sdk.Web Sdk and the same shared runtime package. E.g if LibraryA references Microsoft.AspNetCore.App, any projects referencing it must reference Microsoft.AspNetCore.App.
* Executable projects, i.e. the app that you launch, must not specify the version. The Sdk will specify this for you e.g. <PackageReference Include="Microsoft.AspNetCore.App" /> . This includes "apps" that run and test projects for apps.
* Referenced projects, i.e. projects that aren’t the entry point, that reference Microsoft.AspNetCore.All or Microsoft.AspNetCore.App must specify a package version.
