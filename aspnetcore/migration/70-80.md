...
description: Learn how to migrate an ASP.NET Core in .NET 6 project to ASP.NET Core 8.0
ms.author: riande
ms.date: 10/13/2022
...
For breaking changes from .NET Core .NET 7 to 8, see [Breaking changes in .NET 8](/dotnet/core/compatibility/8.0), which includes [ASP.NET Core](/dotnet/core/compatibility/8.0#aspnet-core) and [Entity Framework Core](/dotnet/core/compatibility/8.0#entity-framework-core) sections.
