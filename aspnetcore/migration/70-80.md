...
1. Make the following changes to the `App.razor` file:
   ...
   Locate and remove the following markup:
   ...
   Replace the `<div>` block with the `Routes` component using the Interactive WebAssembly render mode and prerendering disabled:
