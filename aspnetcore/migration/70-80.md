...
For breaking changes from .NET Core .NET 7.0 to 8.0, see [Breaking changes in .NET 7](/dotnet/core/compatibility/8.0). ASP.NET Core and Entity Framework Core are included in the list.
