...
:::code language="csharp" source="~/migration/fx-to-core/areas/sample8/Program.cs" :::
...
:::code language="csharp" source="~/migration/fx-to-core/areas/sample8/Snippets/GlobalSnippet.cs" id="snippet_AddGlobal" :::
...
:::code language="csharp" source="~/migration/fx-to-core/areas/sample8/Snippets/UseAuthenticationAndAuthorizationSnippet.cs" id="snippet_UseAuthenticationAndAuthorization" :::
...
:::code language="csharp" source="~/migration/fx-to-core/areas/sample8/Snippets/HttpModulePoolingSnippet.cs" id="snippet_ObjectPool" :::
