...
* If your application uses [API analyzers](<xref:web-api/advanced/analyzers), remove any `<PackageReference>` to [Microsoft.AspNetCore.Mvc.Api.Analyzers](https://www.nuget.org/packages/Microsoft.AspNetCore.Mvc.Api.Analyzers/) package. Edit your project file to use the analyzer shipped as part of the .NET Core SDK:
