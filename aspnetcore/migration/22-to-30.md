...
For apps using [IdentityServer](https://identityserver.io/),  or considering using IdentityServer, see [this GitHub discussion issue](https://github.com/aspnet/AspNetCore.Docs/issues/14719).
