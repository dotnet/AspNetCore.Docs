...
### HttpContext.Resource not available through HttpContextAccessor

Due to endpoint routing changes, `HttpContext.Resource` not available through `HttpContextAccessor`. For more information, see [this GitHub issue](https://github.com/aspnet/AspNetCore.Docs/issues/12564);
