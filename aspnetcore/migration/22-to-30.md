...
ASP.NET Core no longer produces a large number of NuGet packages features. These package references should be removed from your project file. For example, the template generated project file for a ASP.NET Core 2.2 web app:
...
* A template created web app with individual user accounts requires adding the following packages:
...
The following image shows the deleted and changed lines in an ASP.NET Core 2.2 Razor Web app:

![the deleted and changed lines in an ASP.NET Core 2.2 Razor Web app](22-to-30/_static/startup2.2.png)

![the deleted and changed lines in an ASP.NET Core 2.2 Razor Web app](22-to-30/_static/startup2.25.png)

In the preceding image, deleted code is shown in red. The deleted code does not show cookie options code, which was deleted prior to comparing the files.

The following image shows the added and changed lines in an ASP.NET Core 3.0 Razor Web app:

![the added and changed lines in an ASP.NET Core 3.0 Razor Web app](22-to-30/_static/startup3.png)
