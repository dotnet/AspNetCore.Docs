...
In 3.0, runtime compilation is an opt-in scenario. To enable runtime compilation, see <xref:mvc/views/view-compilation?view=aspnetcore-3.0#runtime-compilation>.
