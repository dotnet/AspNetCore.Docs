...
* The ASP.NET Core 2.x templates used Bootstrap 3. The ASP.NET Core 3.0 templates use Bootstrap 4. The following code shows an example of how to update to Bootstrap 4:
