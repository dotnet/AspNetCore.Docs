...
<a id="jsonnet-support">
## Change default serializer back to Newtonsoft.Json (Json.NET)
...
### Use Newtonsoft.Json in an ASP.NET Core 3.0 project
...
* Install the [Microsoft.AspNetCore.Mvc.NewtonsoftJson](https://nuget.org/packages/Microsoft.AspNetCore.Mvc.NewtonsoftJson) package.
  ...
  **Note:** A common error is to install the [Newtonsoft.Json](https://www.nuget.org/packages/Newtonsoft.Json/) package instead of the [Microsoft.AspNetCore.Mvc.NewtonsoftJson](https://nuget.org/packages/Microsoft.AspNetCore.Mvc.NewtonsoftJson) package.
