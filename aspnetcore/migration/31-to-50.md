...
The *`Client`* app registration of a hosted Blazor solution that uses AAD or AAD B2C for user authentication should use an SPA Azure Apps platform configuration:

1. In the Azure portal app registration for the *`Client`* app, remove the **Web** platform configuration.
1. Add a **Single-page application (SPA)** platform configuration with the app's redirect URI. 
