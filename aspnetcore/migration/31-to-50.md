...
* [Update Blazor WebAssembly projects](#update-blazor-webassembly-projects) sections
...
After migrating the app to .NET 5, clean and rebuild the app. If package incompatibilities exist between new package references and cached packages:
