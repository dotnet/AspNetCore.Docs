...
## Update Razor Class Libraries

You may consider migrating your Razor Class Libraries to take advantage of new APIs or features that are introduced as part of ASP.NET Core 5.0. 

To update your Razor Class Libraries targeting Components, update the following properties:
...
To update Razor Class Libraries targeting MVC, update the following properties:
