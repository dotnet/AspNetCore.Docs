...
### Standalone Blazor WebAssembly apps with Microsoft Accounts

For standalone Blazor WebAssembly apps registered in the Azure portal to use Azure Active Directory (AAD) for Microsoft Accounts:
...
### Standalone Blazor WebAssembly apps with Azure Active Directory (AAD)

For standalone Blazor WebAssembly apps registered in the Azure portal to use Azure Active Directory (AAD):
...
### Standalone Blazor apps with Azure Active Directory (AAD) B2C

For standalone Blazor WebAssembly apps registered in the Azure portal to use Azure Active Directory (AAD) B2C:
