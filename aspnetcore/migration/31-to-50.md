...
Additionally, *`Server`* projects that authenticate users to client Blazor WebAssembly apps with Azure Active Directory (AAD) or AAD B2C should adopt new Microsoft Identity v2.0 packages: 
...
For Azure Active Directory (AAD) B2C:
