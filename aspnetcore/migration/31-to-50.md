...
* The section that applies to the app's provider with Azure Active Directory:
  ...
  * [Standalone Blazor WebAssembly app with Azure Active Directory (AAD)](#standalone-blazor-webassembly-app-with-microsoft-entra-id)
...
* [Azure Active Directory (AAD)](xref:blazor/security/webassembly/standalone-with-microsoft-entra-id)
* [Azure Active Directory (AAD) B2C](xref:blazor/security/webassembly/standalone-with-azure-active-directory-b2c)

Hosted Blazor WebAssembly apps:

* [Azure Active Directory (AAD)](xref:blazor/security/webassembly/hosted-with-microsoft-entra-id)
