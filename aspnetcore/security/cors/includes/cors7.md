...
In .NET 7, the `[EnableCors]` attribute must pass a parameter or an [ASP0023](xref:diagnostics/asp0023) Warning is generated from a ambiguous match on the route. .NET 8 and later doesn't generate the `ASP0023` warning.
