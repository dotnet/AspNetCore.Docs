...
In ASP.NET Core 7.0, the `[EnableCors]` attribute must pass a parameter or an [ASP0023](xref:diagnostics/code-analysis/asp0023) Warning is generated from a ambiguous match on the route. ASP.NET Core 8.0 and later doesn't generate the `ASP0023` warning.
