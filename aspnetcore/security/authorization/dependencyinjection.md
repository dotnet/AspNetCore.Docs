...
For example, if you wanted to use ASP.NET's logging infrastructure you would to inject [`ILoggerFactory`](ILoggerFactory) into your handler. Such a handler might look like:
...
An instance of the handler will be created when your application starts, and DI will inject the registered [`ILoggerFactory`](ILoggerFactory) into your constructor.
