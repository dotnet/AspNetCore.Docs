...
[!code-csharp[](~/security/authorization/roles/samples/7.x/WebAll/Controllers/AdministrationController.cs?name=snippet&highlight=1)]

Multiple roles can be specified as a comma separated list:

[!code-csharp[](~/security/authorization/roles/samples/7.x/WebAll/Controllers/SalaryController.cs?name=snippet&highlight=1)]
...
[!code-csharp[](~/security/authorization/roles/samples/7.x/WebAll/Controllers/ControlPanelController.cs?name=snippet&highlight=1-2)]

Access to an action can be limited by applying additional role authorization attributes at the action level:

[!code-csharp[](~/security/authorization/roles/samples/7.x/WebAll/Controllers/ControlAllPanelController.cs?name=snippet&highlight=1-2,7)]
...
[!code-csharp[](~/security/authorization/roles/samples/7.x/WebAll/Controllers/Control3PanelController.cs?name=snippet&highlight=1,7)]
...
[!code-csharp[](~/security/authorization/roles/samples/7.x/WebAll/Pages/X/Update.cshtml.cs?name=snippet&highlight=1)]
...
[!code-csharp[](~/security/authorization/roles/samples/7.x/WebAll/Program.cs?name=snippet&highlight=4-6)]
...
[!code-csharp[](~/security/authorization/roles/samples/7.x/WebAll/Controllers/Home2Controller.cs?name=snippet&highlight=1)]
...
[!code-csharp[](~/security/authorization/roles/samples/7.x/WebAll/Program.cs?name=snippet2&highlight=4-6)]
