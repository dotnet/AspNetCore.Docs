...
Authorization components, including the [`AuthorizeAttribute`](AuthorizeAttribute) and [`AllowAnonymousAttribute`](AllowAnonymousAttribute) attributes are found in the [`Microsoft.AspNetCore.Authorization`](Microsoft.AspNetCore.Authorization) namespace.
