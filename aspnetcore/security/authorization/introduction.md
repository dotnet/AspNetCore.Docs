...
Authorization is orthogonal and independent from authentication. Authentication is the process of ascertaining who a user is. Authentication may create one or more identities for the current user. Authorization requires an authentication mechanism.
