...
If you prefer to specify the desired schemes in [policy](policies.md#security-authorization-policies-based) you can set the [`AuthenticationSchemes`](AuthenticationSchemes) collection when adding your policy.
