...
Once you have injected the authorization service you use it by calling the [`AuthorizeAsync`](AuthorizeAsync) method in exactly the same way as you would check during [resource based authorization](resourcebased.md#security-authorization-resource-based-imperative).
...
In some cases the resource will be your view model, and you can call [`AuthorizeAsync`](AuthorizeAsync) in exactly the same way as you would check during [resource based authorization](resourcebased.md#security-authorization-resource-based-imperative);
