...
```
In order for your application to communicate and authorise itself with KeyVault, you must also include the [Azure.Identity](https://www.nuget.org/packages/Azure.Identity/) package within your solution.
...
If the app uses the older Azure packages (Microsoft.AspNetCore.DataProtection.AzureStorage and Microsoft.AspNetCore.DataProtection.AzureKeyVault) it is recommended that you ***remove*** these references an upgrade to the [Azure.Extensions.AspNetCore.DataProtection.Blobs](https://www.nuget.org/packages/Azure.Extensions.AspNetCore.DataProtection.Blobs)
and [Azure.Extensions.AspNetCore.DataProtection.Keys](https://www.nuget.org/packages/Azure.Extensions.AspNetCore.DataProtection.Keys). These packages are where new updates will be provided, and address some key security and stability issues with the older packages.
