...
> [!WARNING]
> Data configuration keys in this version of .NET can ***NOT*** maintain data consistency in web farms and [Azure Container Apps](/azure/container-apps/overview). See the the [.NET 8 version or later of this document](/aspnet/core/security/data-protection/introduction?view=aspnetcore-80.0) for information on how to maintain data consistency in web farms and Azure Container Apps.
