...
2. Complete the **GET NEW ACCESS TOKEN** dialog as follows:
   ...
   |       <strong>Auth URL</strong>        | `https://login.microsoftonline.com/<tenant domain name>/B2C_1_SiUpIn/oauth2/v2.0/authorize` |                                                                                                  Replace <em>&lt;tenant domain name&gt;</em> with the tenant's domain name.                                                                                                  |
