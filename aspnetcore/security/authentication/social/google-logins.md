...
* HTTP 500 error after successfully authenticating the request by the oauth provider such as google: See [this GitHub issue](https://github.com/dotnet/AspNetCore.Docs/issues/14169).
