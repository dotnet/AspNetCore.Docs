...
View the [completed sample](https://github.com/aspnet/Docs/tree/master/aspnetcore/security/authentication/2fa/sample/Web2FA). [Download instructions](xref:tutorials/index#how-to-download-a-sampleing-a-sample).
