...
This check validates that only the appropriate certificate type is allowed. If the application is using self signed certificates, this option needs to be set to All or SelfSigned.
