...
The [Options pattern](xref:fundamentals/configuration#options) is used to access the user account and key settings. For more information, see [configuration](xref:fundamentals/configuration).
