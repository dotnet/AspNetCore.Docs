...
author: wadepickett
description: Learn how to add custom user data to Identity in an ASP.NET Core project. Mark the data so it can be downloaded and deleted to address GDPR requirements.
ms.author: wpickett
ms.custom: mvc
ms.date: 05/19/2026
