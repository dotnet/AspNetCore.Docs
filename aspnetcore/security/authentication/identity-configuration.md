...
Locks out the user for a period of time after a given number of failed access attempts (default: 5 minute lockout after 5 failed access attempts). A successful login resets the failed access attempts count and resets the clock.
