...
[!code-csharp[](../sample/WebApp6x/Program.cs?name=snippet_)]
...
[!code-csharp[](../sample/WebApp3/Areas/Identity/Pages/Account/Register.cshtml.cs?name=snippet&highlight=9)]
...
[!code-csharp[](../sample/WebApp3/Areas/Identity/Pages/Account/Login.cshtml.cs?name=snippet&highlight=10-11)]
...
[!code-csharp[](../sample/WebApp3/Areas/Identity/Pages/Account/Logout.cshtml.cs?highlight=36)]
...
[!code-csharp[](../sample/WebApp3/Pages/Privacy.cshtml.cs?highlight=7)]
...
[!code-csharp[](../sample/WebApp3/Startup.cs?name=snippet_configureservices&highlight=11-99)]
...
[!code-csharp[](../sample/WebApp3/Startup.cs?name=snippet_configure&highlight=19)]

:::moniker-end

:::moniker range=">= aspnetcore-5.0 < aspnetcore-6.0"

[!code-csharp[](../sample/WebApp5x/Startup.cs?name=snippet_configureservices&highlight=12-99)]

The preceding code configures Identity with default option values. Services are made available to the app through [dependency injection](xref:fundamentals/dependency-injection).

Identity is enabled by calling <xref:Microsoft.AspNetCore.Builder.AuthAppBuilderExtensions.UseAuthentication%2A>. `UseAuthentication` adds authentication [middleware](xref:fundamentals/middleware/index) to the request pipeline.

[!code-csharp[](../sample/WebApp5x/Startup.cs?name=snippet_configure&highlight=19)]
