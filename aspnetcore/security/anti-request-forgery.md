...
> [!NOTE]
>  [Razor Pages](xref: mvc/razor-pages/index) are automatically protected from XSRF/CSRF, you don't have to write any additial code. See [XSRF/CSRF and Razor Pages](xref: mvc/razor-pages/index#xsrf) for more information.
