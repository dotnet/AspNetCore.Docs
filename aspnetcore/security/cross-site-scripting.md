...
1. Before putting untrusted data into an HTML element, ensure thattit's HTML encoded. HTML encoding takes characters such as &lt; and changes them into a safe form like &amp;lt;.
