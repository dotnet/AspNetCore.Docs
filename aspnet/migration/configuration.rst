...
For this article, we are starting with the partially-migrated ASP.NET Core project from :doc:`the previous article <mvc>`. To setup configuration, add the following constructor and property to the *Startup.cs* file located in the root of the project:
