...
msc.legacyurl: /mvc/overview/deployment/visual-studio-web-deployment/deploying-extra-files
---
[Edit .md file](C:\Projects\msc\dev\Msc.Www\Web.ASP\App_Data\github\mvc\overview\deployment\visual-studio-web-deployment\deploying-extra-files.md) | [Edit dev content](http://www.aspdev.net/umbraco#/content/content/edit/45347) | [View dev content](http://docs.aspdev.net/tutorials/mvc/overview/deployment/visual-studio-web-deployment/deploying-extra-files.html) | [View prod content](http://www.asp.net/mvc/overview/deployment/visual-studio-web-deployment/deploying-extra-files) | Picker: 45361
...
3. At the end of the file, before the closing `</Project>` tag, add the following markup that specifies when to execute the new target.
    ...
    [!code[Main](deploying-extra-files/samples/sample1.xml?highlight=53-71)]
...
>[!div class="step-by-step"] [Previous](command-line-deployment.md) [Next](troubleshooting.md)