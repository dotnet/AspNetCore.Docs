...
[!code[Main](iteration-7-add-ajax-functionality-vb/samples/sample1.xml)]
...
[!code[Main](iteration-7-add-ajax-functionality-vb/samples/sample2.xml)]
...
[!code[Main](iteration-7-add-ajax-functionality-vb/samples/sample3.xml)]
...
[!code[Main](iteration-7-add-ajax-functionality-vb/samples/sample4.xml)]
...
[!code[Main](iteration-7-add-ajax-functionality-vb/samples/sample5.xml)]
...
[!code[Main](iteration-7-add-ajax-functionality-vb/samples/sample6.xml)]
...
[!code[Main](iteration-7-add-ajax-functionality-vb/samples/sample7.xml)]
...
[!code[Main](iteration-7-add-ajax-functionality-vb/samples/sample8.xml)]
...
[!code[Main](iteration-7-add-ajax-functionality-vb/samples/sample9.xml)]
...
[!code[Main](iteration-7-add-ajax-functionality-vb/samples/sample10.xml)]

The Delete link is rendered with the following call to the Ajax.ImageActionLink() method:

[!code[Main](iteration-7-add-ajax-functionality-vb/samples/sample11.xml)]
...
[!code[Main](iteration-7-add-ajax-functionality-vb/samples/sample12.xml)]
