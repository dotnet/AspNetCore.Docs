...
[!INCLUDE[consider RP](../../../../includes/razor.md)]
 ...
 This tutorial will teach you the basics of building an ASP.NET MVC 5 web app using [Visual Studio 2017](https://www.visualstudio.com/). Source located on [GitHub](xref:mvc/overview/getting-started/introduction/sample/MvcMovie)
