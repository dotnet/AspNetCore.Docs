...
---
[Edit .md file](C:\Projects\msc\dev\Msc.Www\Web.ASP\App_Data\github\mvc\overview\older-versions\using-the-html5-and-jquery-ui-datepicker-popup-calendar-with-aspnet-mvc\using-the-html5-and-jquery-ui-datepicker-popup-calendar-with-aspnet-mvc-part-1.md) | [Edit dev content](http://www.aspdev.net/umbraco#/content/content/edit/24911) | [View dev content](http://docs.aspdev.net/tutorials/mvc/overview/older-versions/using-the-html5-and-jquery-ui-datepicker-popup-calendar-with-aspnet-mvc/using-the-html5-and-jquery-ui-datepicker-popup-calendar-with-aspnet-mvc-part-1.html) | [View prod content](http://www.asp.net/mvc/overview/older-versions/using-the-html5-and-jquery-ui-datepicker-popup-calendar-with-aspnet-mvc/using-the-html5-and-jquery-ui-datepicker-popup-calendar-with-aspnet-mvc-part-1) | Picker: 27549
