...
[!code[Main](dynamic-v-strongly-typed-views/samples/sample1.xml)]
...
[!code[Main](dynamic-v-strongly-typed-views/samples/sample2.xml)]

[!code[Main](dynamic-v-strongly-typed-views/samples/sample3.xml)]
...
[!code[Main](dynamic-v-strongly-typed-views/samples/sample4.xml)]

[![6646.NotStronglyTypedView_5F00_IE[1]](dynamic-v-strongly-typed-views/_static/image4.png)](dynamic-v-strongly-typed-views/_static/image3.png)

Now we'll add a strongly typed view. Add the following code to the controller:

[!code[Main](dynamic-v-strongly-typed-views/samples/sample5.xml)]
