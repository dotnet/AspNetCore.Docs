...
In this tutorial, you’ll create a simple web app using ASP.NET MVC and Entity Framework (EF). The app stores data in a SQL database and supports the basic CRUD operations (create, read, update, delete). 

.. note:: This tutorial uses Visual Studio 2015.

The sample app that you'll build manages a list of authors and books. When you have completed this tutorial, your app will be deploy to Azure:

.. image:: mvc-with-entity-framework/_static/01-screenshot1.png
...
.. note:: You can browse the source code for the related sample app on `GitHub <https://github.com/aspnet/Docs/tree/master/mvc/tutorials/mvc-with-entity-framework/sample>`_.

Audience
^^^^^^^^
The intended audience of this tutorial is experienced developers who are new to ASP.NET and Entity Framework. A developer interested in this tutorial should have the following skills:
...
- `HTML, CSS, JavaScript, SQL, PHP, JQuery <http://www.w3schools.com/>`_
- `Getting Started with Visual C# <http://msdn.microsoft.com/library/a72418yk.aspx>`_
- `Relational database concepts <http://en.wikipedia.org/wiki/Relational_database>`_
- `Multitier architecture concepts <http://en.wikipedia.org/wiki/Multitier_architecture>`_
- `Cloud development <http://www.asp.net/aspnet/overview/developing-apps-with-windows-azure/building-real-world-cloud-apps-with-windows-azure/introduction>`_

What you’ll learn
^^^^^^^^^^^^^^^^^
The concepts presented in this tutorial include:

- Creating, reviewing and running a new project
- The file structure of the project
- How to run the project in Visual Studio 2015
- The features of the default ASP.NET 5 application
- How to create a data model
- How to initialize and seed a database
- How to configure and update the app to support the database
- How to publish and run the web app in Azure
...
- `Entity Framework`_
- `Create a data model and scaffolding`_
- `Using data migrations to create the database`_
- `Adding navigation`_
- `Run the web app locally`_
- `Publish the web app to Azure App Service`_
- `Summary`_
...
1. Install `Visual Studio 2015 <http://go.microsoft.com/fwlink/?LinkId=532606>`_
2. Install the latest `ASP.NET 5 preview (RC 1) <https://docs.asp.net/en/latest/getting-started/installing-on-windows.html>`_

.. note:: For additional information about installing ASP.NET 5 on other platforms, see `ASP.NET 5 Documentation - Getting Started <http://docs.asp.net/en/latest/index.html>`_.
...
.. image:: mvc-with-entity-framework/_static/02-new-project.png

In the **New Project** dialog, select **Web Site** under **ASP.NET 5 Preview Templates**.

.. image:: mvc-with-entity-framework/_static/03-web-site-template.png
...
.. image:: mvc-with-entity-framework/_static/05-browser-runapp.png
...
.. image:: mvc-with-entity-framework/_static/06-solution-explorer.png
...
Understanding MVC
^^^^^^^^^^^^^^^^^
This project uses the MVC framework. MVC stands for model-view-controller. MVC is a pattern for developing applications that are well architected, testable, and easy to maintain. MVC-based applications contain:
...
.. image:: mvc-with-entity-framework/_static/15-add-new-item.png
...
.. image:: mvc-with-entity-framework/_static/15a-scaffold-menu.png

From the **Add Scaffold** dialog box, select **MVC 6 Controller with views, using Entity Framework**, then click the **Add** button.

.. image:: mvc-with-entity-framework/_static/15b-add-scaffold-db.png
...
.. image:: mvc-with-entity-framework/_static/15c-book-controller.png
...
.. image:: mvc-with-entity-framework/_static/15d-author-controller.png
...
.. image:: mvc-with-entity-framework/_static/15d2-di-intellisense.png
...
.. image:: mvc-with-entity-framework/_static/15d3-package-restore.png
...
.. image:: mvc-with-entity-framework/_static/19-vs-build-output.png
...
.. image:: mvc-with-entity-framework/_static/16-migrations.png

Also, you will be able to view the newly created database within **SQL Server Object Explorer**. 

.. image:: mvc-with-entity-framework/_static/16a-database.png
...
.. image:: mvc-with-entity-framework/_static/19a-running-app.png
...
Enter a unique site name, and select an app service plan, resource group, and region. Also, choose to create a database server, along with a database username and password. If you’ve created a database server in the past, use that. When you’re ready to continue, click **Create**.
	...
	.. image:: mvc-with-entity-framework/_static/23-vs-createwebappdb.png
	
On the **Connection** tab of the **Publish Web** window, click **Publish**.

	.. image:: mvc-with-entity-framework/_static/24-vs-publishwebdb-target.png
...
You can view the publishing progress in eith the **Output** window or the **Azure App Service Activity** window within Visual Studio.
	...
	.. image:: mvc-with-entity-framework/_static/25-vs-webpubactivity.png
	
When publishing to Azure is complete, your web app will be displayed in a browser running on Azure.

	.. image:: mvc-with-entity-framework/_static/26-browserazure.png

For additional publishing information, see `Publishing and Deployment <http://docs.asp.net/en/latest/publishing/>`_.
	
Summary
-------
In this topic you have learned how to create a web app using ASP.NET MVC and Entity Framework (EF). You created a data model and performed scaffolding. Also, you used data migrations to create the database, added navigation, and published the app to Azure.
