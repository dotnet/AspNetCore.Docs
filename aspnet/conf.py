...
# -*- coding: utf-8 -*-
#
# ASP.NET documentation build configuration file, created by
...
.. raw:: html
	...
	<input type="text" id="txt-helpfulness" value="Please let us know why this wasn't helpful" data-uitext="Please let us know why this wasn't helpful" data-uitype="autoreset" maxlength="160"><span id="helpfulness-characters-left">160 characters remaining</span><a id="helpfulness-btn-submit" href="javascript:;" class="common-btn">Submit</a><a id="helpfulness-btn-skip" href="javascript:;" class="common-btn secondary">Skip this</a></div><a href="javascript:;" class="helpfulness-close">✖</a><div class="messages processing" style="display:none;">Sending feedback...</div><div class="messages success" style="display:none;">Thank you for your feedback!</div><div class="messages error" style="display:none;">Error during submission!</div></div></div>
