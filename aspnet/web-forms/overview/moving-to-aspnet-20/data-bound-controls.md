...
---
[Edit .md file](C:\Projects\msc\dev\Msc.Www\Web.ASP\App_Data\github\web-forms\overview\moving-to-aspnet-20\data-bound-controls.md) | [Edit dev content](http://www.aspdev.net/umbraco#/content/content/edit/25173) | [View dev content](http://docs.aspdev.net/tutorials/web-forms/overview/moving-to-aspnet-20/data-bound-controls.html) | [View prod content](http://www.asp.net/web-forms/overview/moving-to-aspnet-20/data-bound-controls) | Picker: 33385
...
> [!NOTE] The Height and Width attributes override the height and width for the AdRotator control itself.
...
> [!NOTE] Inserting records into the data source is not directly supported by the GridView control. However, it is possible to insert records by using the GridView control in conjunction with the DetailsView or FormView control.
...
> [!NOTE] It is almost certain that you might encounter situations where menus don't appear to render due to the MaximumDynamicDisplayLevels property. In those cases, ensure that the property is set sufficiently to allow for the display of the customers menus.
