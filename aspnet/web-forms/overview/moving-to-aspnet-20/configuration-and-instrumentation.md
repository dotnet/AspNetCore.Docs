...
[!code[Main](configuration-and-instrumentation/samples/sample1.xml)]
...
[!code[Main](configuration-and-instrumentation/samples/sample2.xml)]
...
[!code[Main](configuration-and-instrumentation/samples/sample3.xml)]
...
[!code[Main](configuration-and-instrumentation/samples/sample4.xml)]
...
[!code[Main](configuration-and-instrumentation/samples/sample5.xml)]
...
[!code[Main](configuration-and-instrumentation/samples/sample6.xml)]
...
[!code[Main](configuration-and-instrumentation/samples/sample7.xml)]

If you wanted to only send errors to SQL Server, you could add the following rule:

[!code[Main](configuration-and-instrumentation/samples/sample8.xml)]
...
[!code[Main](configuration-and-instrumentation/samples/sample9.xml)]
...
[!code[Main](configuration-and-instrumentation/samples/sample10.xml)]
...
[!code[Main](configuration-and-instrumentation/samples/sample11.xml)]

The following rule is also added to tie the e-mail provider to the **All Events** event map:

[!code[Main](configuration-and-instrumentation/samples/sample12.xml)]
...
[!code[Main](configuration-and-instrumentation/samples/sample13.xml)]
...
[!code[Main](configuration-and-instrumentation/samples/sample14.xml)]
...
[!code[Main](configuration-and-instrumentation/samples/sample15.xml)]

1. Add two private variables to the class and a Page\_Init method as shown below:


[!code[Main](configuration-and-instrumentation/samples/sample16.xml)]

1. Add the following code to Page\_Load:


[!code[Main](configuration-and-instrumentation/samples/sample17.xml)]
...
[!code[Main](configuration-and-instrumentation/samples/sample18.xml)]
...
[!code[Main](configuration-and-instrumentation/samples/sample19.xml)]

1. Add the following code to the existing code in Page\_Init:


[!code[Main](configuration-and-instrumentation/samples/sample20.xml)]

1. Double-click on the DropDownList and add the following code to the SelectedIndexChanged event:


[!code[Main](configuration-and-instrumentation/samples/sample21.xml)]
