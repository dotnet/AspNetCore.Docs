...
---
[Edit .md file](C:\Projects\msc\dev\Msc.Www\Web.ASP\App_Data\github\web-forms\overview\older-versions-security\membership\creating-the-membership-schema-in-sql-server-cs.md) | [Edit dev content](http://www.aspdev.net/umbraco#/content/content/edit/25158) | [View dev content](http://docs.aspdev.net/tutorials/web-forms/overview/older-versions-security/membership/creating-the-membership-schema-in-sql-server-cs.html) | [View prod content](http://www.asp.net/web-forms/overview/older-versions-security/membership/creating-the-membership-schema-in-sql-server-cs) | Picker: 33370
...
>[!div class="step-by-step"] [Next](creating-user-accounts-cs.md)