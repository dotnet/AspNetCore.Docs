...
[!code[Main](user-based-authorization-vb/samples/sample1.xml)]
...
[!code[Main](user-based-authorization-vb/samples/sample2.xml)]

To allow only authenticated users, use the following configuration, which denies access to all anonymous users:

[!code[Main](user-based-authorization-vb/samples/sample3.xml)]
...
[!code[Main](user-based-authorization-vb/samples/sample4.xml)]
...
[!code[Main](user-based-authorization-vb/samples/sample5.xml)]
...
[!code[Main](user-based-authorization-vb/samples/sample6.xml)]
...
[!code[Main](user-based-authorization-vb/samples/sample7.xml)]
...
[!code[Main](user-based-authorization-vb/samples/sample8.xml)]
...
[!code[Main](user-based-authorization-vb/samples/sample9.xml)]
...
[!code[Main](user-based-authorization-vb/samples/sample10.xml)]
...
[!code[Main](user-based-authorization-vb/samples/sample11.xml)]
...
[!code[Main](user-based-authorization-vb/samples/sample12.xml)]
...
[!code[Main](user-based-authorization-vb/samples/sample13.xml)]
...
[!code[Main](user-based-authorization-vb/samples/sample14.xml)]
...
[!code[Main](user-based-authorization-vb/samples/sample15.xml)]
...
[!code[Main](user-based-authorization-vb/samples/sample16.xml)]
...
[!code[Main](user-based-authorization-vb/samples/sample17.xml)]
...
[!code[Main](user-based-authorization-vb/samples/sample18.xml)]

 To: 

[!code[Main](user-based-authorization-vb/samples/sample19.xml)]
...
[!code[Main](user-based-authorization-vb/samples/sample20.xml)]
...
[!code[Main](user-based-authorization-vb/samples/sample21.xml)]
...
[!code[Main](user-based-authorization-vb/samples/sample22.xml)]
...
[!code[Main](user-based-authorization-vb/samples/sample23.xml)]
