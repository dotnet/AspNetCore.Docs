...
---
[Edit .md file](C:\Projects\msc\dev\Msc.Www\Web.ASP\App_Data\github\web-forms\overview\older-versions-security\roles\creating-and-managing-roles-vb.md) | [Edit dev content](http://www.aspdev.net/umbraco#/content/content/edit/25207) | [View dev content](http://docs.aspdev.net/tutorials/web-forms/overview/older-versions-security/roles/creating-and-managing-roles-vb.html) | [View prod content](http://www.asp.net/web-forms/overview/older-versions-security/roles/creating-and-managing-roles-vb) | Picker: 33403
...
>[!div class="step-by-step"] [Previous](role-based-authorization-cs.md) [Next](assigning-roles-to-users-vb.md)