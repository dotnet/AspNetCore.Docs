...
---
[Edit .md file](C:\Projects\msc\dev\Msc.Www\Web.ASP\App_Data\github\web-forms\overview\older-versions-security\introduction\security-basics-and-asp-net-support-vb.md) | [Edit dev content](http://www.aspdev.net/umbraco#/content/content/edit/25118) | [View dev content](http://docs.aspdev.net/tutorials/web-forms/overview/older-versions-security/introduction/security-basics-and-asp-net-support-vb.html) | [View prod content](http://www.asp.net/web-forms/overview/older-versions-security/introduction/security-basics-and-asp-net-support-vb) | Picker: 33334
...
>[!div class="step-by-step"] [Previous](forms-authentication-configuration-and-advanced-topics-cs.md) [Next](an-overview-of-forms-authentication-vb.md)