...
[!code[Main](nested-data-web-controls-cs/samples/sample1.xml)]
...
[!code[Main](nested-data-web-controls-cs/samples/sample2.xml)]
...
[!code[Main](nested-data-web-controls-cs/samples/sample3.xml)]
...
[!code[Main](nested-data-web-controls-cs/samples/sample4.xml)]
...
[!code[Main](nested-data-web-controls-cs/samples/sample5.xml)]
...
[!code[Main](nested-data-web-controls-cs/samples/sample6.xml)]
...
[!code[Main](nested-data-web-controls-cs/samples/sample7.xml)]
...
> [!NOTE] It may seem like busywork to create the `GetProductsInCategory(categoryID)` method in the ASP.NET page s code-behind class. After all, this method simply creates an instance of the `ProductsBLL` class and returns the results of its `GetProductsByCategoryID(categoryID)` method. Why not just call this method directly from the databinding syntax in the inner Repeater, like: `DataSource='<%# ProductsBLL.GetProductsByCategoryID((int)(Eval("CategoryID"))) %>'`? Although this syntax won t work with our current implementation of the `ProductsBLL` class (since the `GetProductsByCategoryID(categoryID)` method is an instance method), you could modify `ProductsBLL` to include a static `GetProductsByCategoryID(categoryID)` method or have the class include a static `Instance()` method to return a new instance of the `ProductsBLL` class.
...
[!code[Main](nested-data-web-controls-cs/samples/sample8.xml)]
...
>[!div class="step-by-step"] [Previous](showing-multiple-records-per-row-with-the-datalist-control-cs.md) [Next](displaying-data-with-the-datalist-and-repeater-controls-vb.md)