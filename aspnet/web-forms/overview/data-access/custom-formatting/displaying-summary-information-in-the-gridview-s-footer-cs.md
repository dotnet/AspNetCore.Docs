...
- \_`totalUnitsInStock`, of type `int`
- \_`totalUnitsOnOrder`, of type `int`
...
>[!div class="step-by-step"] [Previous](using-the-formview-s-templates-cs.md) [Next](custom-formatting-based-upon-data-vb.md)