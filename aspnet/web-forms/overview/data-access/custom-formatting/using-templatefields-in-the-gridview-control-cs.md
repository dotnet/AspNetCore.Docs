...
---
[Edit .md file](C:\Projects\msc\dev\Msc.Www\Web.ASP\App_Data\github\web-forms\overview\data-access\custom-formatting\using-templatefields-in-the-gridview-control-cs.md) | [Edit dev content](http://www.aspdev.net/umbraco#/content/content/edit/24996) | [View dev content](http://docs.aspdev.net/tutorials/web-forms/overview/data-access/custom-formatting/using-templatefields-in-the-gridview-control-cs.html) | [View prod content](http://www.asp.net/web-forms/overview/data-access/custom-formatting/using-templatefields-in-the-gridview-control-cs) | Picker: 33236
...
>[!div class="step-by-step"] [Previous](custom-formatting-based-upon-data-cs.md) [Next](using-templatefields-in-the-detailsview-control-cs.md)