...
---
[Edit .md file](C:\Projects\msc\dev\Msc.Www\Web.ASP\App_Data\github\web-forms\overview\data-access\advanced-data-access-scenarios\working-with-computed-columns-cs.md) | [Edit dev content](http://www.aspdev.net/umbraco#/content/content/edit/24758) | [View dev content](http://docs.aspdev.net/tutorials/web-forms/overview/data-access/advanced-data-access-scenarios/working-with-computed-columns-cs.html) | [View prod content](http://www.asp.net/web-forms/overview/data-access/advanced-data-access-scenarios/working-with-computed-columns-cs) | Picker: 33058
...
>[!div class="step-by-step"] [Previous](adding-additional-datatable-columns-cs.md) [Next](configuring-the-data-access-layer-s-connection-and-command-level-settings-cs.md)