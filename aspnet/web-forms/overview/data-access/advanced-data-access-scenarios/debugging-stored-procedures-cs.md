...
---
[Edit .md file](C:\Projects\msc\dev\Msc.Www\Web.ASP\App_Data\github\web-forms\overview\data-access\advanced-data-access-scenarios\debugging-stored-procedures-cs.md) | [Edit dev content](http://www.aspdev.net/umbraco#/content/content/edit/24764) | [View dev content](http://docs.aspdev.net/tutorials/web-forms/overview/data-access/advanced-data-access-scenarios/debugging-stored-procedures-cs.html) | [View prod content](http://www.asp.net/web-forms/overview/data-access/advanced-data-access-scenarios/debugging-stored-procedures-cs) | Picker: 33064
...
>[!div class="step-by-step"] [Previous](protecting-connection-strings-and-other-configuration-information-cs.md) [Next](creating-stored-procedures-and-user-defined-functions-with-managed-code-cs.md)