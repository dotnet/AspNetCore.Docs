...
---
[Edit .md file](C:\Projects\msc\dev\Msc.Www\Web.ASP\App_Data\github\web-forms\overview\data-access\caching-data\using-sql-cache-dependencies-cs.md) | [Edit dev content](http://www.aspdev.net/umbraco#/content/content/edit/24978) | [View dev content](http://docs.aspdev.net/tutorials/web-forms/overview/data-access/caching-data/using-sql-cache-dependencies-cs.html) | [View prod content](http://www.asp.net/web-forms/overview/data-access/caching-data/using-sql-cache-dependencies-cs) | Picker: 33218
...
>[!div class="step-by-step"] [Previous](caching-data-at-application-startup-cs.md) [Next](caching-data-with-the-objectdatasource-vb.md)