...
Generation Options Dialog Box](implementing-optimistic-concurrency-with-the-sqldatasource-vb/_static/image1.gif)
...
[!code[Main](implementing-optimistic-concurrency-with-the-sqldatasource-vb/samples/sample1.xml)]
...
[!code[Main](implementing-optimistic-concurrency-with-the-sqldatasource-vb/samples/sample2.xml)]

With seven parameters in the `UpdateParameters` collection:


[!code[Main](implementing-optimistic-concurrency-with-the-sqldatasource-vb/samples/sample3.xml)]

Similarly, the `DeleteCommand` property and `DeleteParameters` collection should look like the following:


[!code[Main](implementing-optimistic-concurrency-with-the-sqldatasource-vb/samples/sample4.xml)]


[!code[Main](implementing-optimistic-concurrency-with-the-sqldatasource-vb/samples/sample5.xml)]
...
[!code[Main](implementing-optimistic-concurrency-with-the-sqldatasource-vb/samples/sample6.xml)]
...
[!code[Main](implementing-optimistic-concurrency-with-the-sqldatasource-vb/samples/sample7.xml)]
...
[!code[Main](implementing-optimistic-concurrency-with-the-sqldatasource-vb/samples/sample8.xml)]
...
[!code[Main](implementing-optimistic-concurrency-with-the-sqldatasource-vb/samples/sample9.xml)]
...
[!code[Main](implementing-optimistic-concurrency-with-the-sqldatasource-vb/samples/sample10.xml)]
...
[!code[Main](implementing-optimistic-concurrency-with-the-sqldatasource-vb/samples/sample11.xml)]
...
>[!div class="step-by-step"] [Previous](inserting-updating-and-deleting-data-with-the-sqldatasource-vb.md)