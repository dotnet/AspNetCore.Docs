...
[!code[Main](adding-client-side-confirmation-when-deleting-cs/samples/sample1.xml)]
...
[!code[Main](adding-client-side-confirmation-when-deleting-cs/samples/sample2.xml)]
...
[!code[Main](adding-client-side-confirmation-when-deleting-cs/samples/sample3.xml)]
...
[!code[Main](adding-client-side-confirmation-when-deleting-cs/samples/sample4.xml)]
...
[!code[Main](adding-client-side-confirmation-when-deleting-cs/samples/sample5.xml)]
...
[!code[Main](adding-client-side-confirmation-when-deleting-cs/samples/sample6.xml)]
...
[!code[Main](adding-client-side-confirmation-when-deleting-cs/samples/sample7.xml)]
...
>[!div class="step-by-step"] [Previous](implementing-optimistic-concurrency-cs.md) [Next](limiting-data-modification-functionality-based-on-the-user-cs.md)