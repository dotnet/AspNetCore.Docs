...
---
[Edit .md file](C:\Projects\msc\dev\Msc.Www\Web.ASP\App_Data\github\web-forms\overview\data-access\working-with-binary-files\uploading-files-cs.md) | [Edit dev content](http://www.aspdev.net/umbraco#/content/content/edit/25272) | [View dev content](http://docs.aspdev.net/tutorials/web-forms/overview/data-access/working-with-binary-files/uploading-files-cs.html) | [View prod content](http://www.asp.net/web-forms/overview/data-access/working-with-binary-files/uploading-files-cs) | Picker: 33439
...
Data Tutorials](uploading-files-cs/_static/image3.gif)
...
~/Brochures Folder](uploading-files-cs/_static/image15.gif)
...
>[!div class="step-by-step"] [Next](displaying-binary-data-in-the-data-web-controls-cs.md)