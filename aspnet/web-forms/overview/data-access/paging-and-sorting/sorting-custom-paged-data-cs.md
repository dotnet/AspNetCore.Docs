...
---
[Edit .md file](C:\Projects\msc\dev\Msc.Www\Web.ASP\App_Data\github\web-forms\overview\data-access\paging-and-sorting\sorting-custom-paged-data-cs.md) | [Edit dev content](http://www.aspdev.net/umbraco#/content/content/edit/25198) | [View dev content](http://docs.aspdev.net/tutorials/web-forms/overview/data-access/paging-and-sorting/sorting-custom-paged-data-cs.html) | [View prod content](http://www.asp.net/web-forms/overview/data-access/paging-and-sorting/sorting-custom-paged-data-cs) | Picker: 33394
...
>[!div class="step-by-step"] [Previous](efficiently-paging-through-large-amounts-of-data-cs.md) [Next](creating-a-customized-sorting-user-interface-cs.md)