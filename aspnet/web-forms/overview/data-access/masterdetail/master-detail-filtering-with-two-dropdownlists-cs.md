...
---
[Edit .md file](C:\Projects\msc\dev\Msc.Www\Web.ASP\App_Data\github\web-forms\overview\data-access\masterdetail\master-detail-filtering-with-two-dropdownlists-cs.md) | [Edit dev content](http://www.aspdev.net/umbraco#/content/content/edit/25152) | [View dev content](http://docs.aspdev.net/tutorials/web-forms/overview/data-access/masterdetail/master-detail-filtering-with-two-dropdownlists-cs.html) | [View prod content](http://www.asp.net/web-forms/overview/data-access/masterdetail/master-detail-filtering-with-two-dropdownlists-cs) | Picker: 33364
...
>[!div class="step-by-step"] [Previous](master-detail-filtering-with-a-dropdownlist-cs.md) [Next](master-detail-filtering-across-two-pages-cs.md)