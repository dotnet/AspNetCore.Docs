...
---
[Edit .md file](C:\Projects\msc\dev\Msc.Www\Web.ASP\App_Data\github\web-forms\overview\data-access\custom-button-actions\adding-and-responding-to-buttons-to-a-gridview-cs.md) | [Edit dev content](http://www.aspdev.net/umbraco#/content/content/edit/24990) | [View dev content](http://docs.aspdev.net/tutorials/web-forms/overview/data-access/custom-button-actions/adding-and-responding-to-buttons-to-a-gridview-cs.html) | [View prod content](http://www.asp.net/web-forms/overview/data-access/custom-button-actions/adding-and-responding-to-buttons-to-a-gridview-cs) | Picker: 33230
