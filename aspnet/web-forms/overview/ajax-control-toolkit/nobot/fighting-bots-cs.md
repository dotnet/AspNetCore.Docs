...
[!code[Main](fighting-bots-cs/samples/sample1.xml)]
...
[!code[Main](fighting-bots-cs/samples/sample2.xml)]
...
[!code[Main](fighting-bots-cs/samples/sample3.xml)]

Finally, you need a form to submit and a label element to output the message, and you are done!

[!code[Main](fighting-bots-cs/samples/sample4.xml)]
