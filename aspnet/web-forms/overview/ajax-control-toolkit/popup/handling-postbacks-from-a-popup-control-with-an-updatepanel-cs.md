...
[!code[Main](handling-postbacks-from-a-popup-control-with-an-updatepanel-cs/samples/sample1.xml)]
...
[!code[Main](handling-postbacks-from-a-popup-control-with-an-updatepanel-cs/samples/sample2.xml)]
