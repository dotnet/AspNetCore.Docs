...
[!code[Main](allowing-only-certain-characters-in-a-text-box-cs/samples/sample1.xml)]

Then, we need a text box:

[!code[Main](allowing-only-certain-characters-in-a-text-box-cs/samples/sample2.xml)]
...
[!code[Main](allowing-only-certain-characters-in-a-text-box-cs/samples/sample3.xml)]
