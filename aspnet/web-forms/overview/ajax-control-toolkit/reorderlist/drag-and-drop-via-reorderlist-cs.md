...
[!code[Main](drag-and-drop-via-reorderlist-cs/samples/sample1.xml)]
...
[!code[Main](drag-and-drop-via-reorderlist-cs/samples/sample2.xml)]
...
[!code[Main](drag-and-drop-via-reorderlist-cs/samples/sample3.xml)]

Finally, a `ScriptManager` control initializes ASP.NET AJAX for the page:

[!code[Main](drag-and-drop-via-reorderlist-cs/samples/sample4.xml)]
