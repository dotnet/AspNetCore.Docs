...
---
[Edit .md file](C:\Projects\msc\dev\Msc.Www\Web.ASP\App_Data\github\web-forms\overview\ajax-control-toolkit\confirmbutton\using-a-confirmbutton-in-a-repeater-cs.md) | [Edit dev content](http://www.aspdev.net/umbraco#/content/content/edit/24808) | [View dev content](http://docs.aspdev.net/tutorials/web-forms/overview/ajax-control-toolkit/confirmbutton/using-a-confirmbutton-in-a-repeater-cs.html) | [View prod content](http://www.asp.net/web-forms/overview/ajax-control-toolkit/confirmbutton/using-a-confirmbutton-in-a-repeater-cs) | Picker: 33108
...
>[!div class="step-by-step"] [Next](using-a-confirmbutton-in-a-repeater-vb.md)