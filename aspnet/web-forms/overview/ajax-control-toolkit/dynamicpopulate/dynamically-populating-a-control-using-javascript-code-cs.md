...
[!code[Main](dynamically-populating-a-control-using-javascript-code-cs/samples/sample1.xml)]

In the next step, create a new ASP.NET site and start with the ASP.NET AJAX ScriptManager control:

[!code[Main](dynamically-populating-a-control-using-javascript-code-cs/samples/sample2.xml)]
...
[!code[Main](dynamically-populating-a-control-using-javascript-code-cs/samples/sample3.xml)]
...
[!code[Main](dynamically-populating-a-control-using-javascript-code-cs/samples/sample4.xml)]
...
[!code[Main](dynamically-populating-a-control-using-javascript-code-cs/samples/sample5.xml)]
