...
[!code[Main](triggering-an-animation-in-another-control-cs/samples/sample1.xml)]

The animation will be applied to a panel of text which looks like this:

[!code[Main](triggering-an-animation-in-another-control-cs/samples/sample2.xml)]

In the associated CSS class for the panel, define a nice background color and also set a fixed width for the panel:

[!code[Main](triggering-an-animation-in-another-control-cs/samples/sample3.xml)]
...
[!code[Main](triggering-an-animation-in-another-control-cs/samples/sample4.xml)]
...
[!code[Main](triggering-an-animation-in-another-control-cs/samples/sample5.xml)]
...
[!code[Main](triggering-an-animation-in-another-control-cs/samples/sample6.xml)]
