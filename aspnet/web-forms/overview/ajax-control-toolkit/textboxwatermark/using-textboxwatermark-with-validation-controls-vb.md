...
[!code[Main](using-textboxwatermark-with-validation-controls-vb/samples/sample1.xml)]
...
[!code[Main](using-textboxwatermark-with-validation-controls-vb/samples/sample2.xml)]
...
[!code[Main](using-textboxwatermark-with-validation-controls-vb/samples/sample3.xml)]
...
[!code[Main](using-textboxwatermark-with-validation-controls-vb/samples/sample4.xml)]
