...
---
[Edit .md file](C:\Projects\msc\dev\Msc.Www\Web.ASP\App_Data\github\web-forms\overview\older-versions-getting-started\master-pages\creating-a-site-wide-layout-using-master-pages-cs.md) | [Edit dev content](http://www.aspdev.net/umbraco#/content/content/edit/25116) | [View dev content](http://docs.aspdev.net/tutorials/web-forms/overview/older-versions-getting-started/master-pages/creating-a-site-wide-layout-using-master-pages-cs.html) | [View prod content](http://www.asp.net/web-forms/overview/older-versions-getting-started/master-pages/creating-a-site-wide-layout-using-master-pages-cs) | Picker: 33332
...
>[!div class="step-by-step"] [Next](multiple-contentplaceholders-and-default-content-cs.md)