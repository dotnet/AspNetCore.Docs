...
[!code[Main](master-pages-and-asp-net-ajax-cs/samples/sample1.xml)]
...
Open the `Site.master` master page and add a ScriptManager control to the page within the Web Form, but before the `<div id="topContent">` element (see Figure 1). If you are using Visual Web Developer 2008 or Visual Studio 2008, the ScriptManager control is located in the Toolbox in the AJAX Extensions tab. If you are using Visual Studio 2005, you will need to first install the ASP.NET AJAX framework and add the controls to the Toolbox. Visit the [ASP.NET AJAX download page](https://ajaxcontroltoolkit.codeplex.com/documentation) to get the framework for ASP.NET 2.0.
...
[!code[Main](master-pages-and-asp-net-ajax-cs/samples/sample2.xml)]
...
[!code[Main](master-pages-and-asp-net-ajax-cs/samples/sample3.xml)]
...
[!code[Main](master-pages-and-asp-net-ajax-cs/samples/sample4.xml)]
...
[!code[Main](master-pages-and-asp-net-ajax-cs/samples/sample5.xml)]
...
[!code[Main](master-pages-and-asp-net-ajax-cs/samples/sample6.xml)]
...
[!code[Main](master-pages-and-asp-net-ajax-cs/samples/sample7.xml)]
...
[!code[Main](master-pages-and-asp-net-ajax-cs/samples/sample8.xml)]
...
[!code[Main](master-pages-and-asp-net-ajax-cs/samples/sample9.xml)]
...
[!code[Main](master-pages-and-asp-net-ajax-cs/samples/sample10.xml)]
...
>[!div class="step-by-step"] [Previous](interacting-with-the-content-page-from-the-master-page-cs.md) [Next](specifying-the-master-page-programmatically-cs.md)