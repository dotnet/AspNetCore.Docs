...
---
[Edit .md file](C:\Projects\msc\dev\Msc.Www\Web.ASP\App_Data\github\web-forms\overview\older-versions-getting-started\deploying-web-site-projects\asp-net-hosting-options-cs.md) | [Edit dev content](http://www.aspdev.net/umbraco#/content/content/edit/25134) | [View dev content](http://docs.aspdev.net/tutorials/web-forms/overview/older-versions-getting-started/deploying-web-site-projects/asp-net-hosting-options-cs.html) | [View prod content](http://www.asp.net/web-forms/overview/older-versions-getting-started/deploying-web-site-projects/asp-net-hosting-options-cs) | Picker: 33350
...
>[!div class="step-by-step"] [Next](determining-what-files-need-to-be-deployed-cs.md)