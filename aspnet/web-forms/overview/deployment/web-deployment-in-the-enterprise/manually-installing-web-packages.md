...
---
[Edit .md file](C:\Projects\msc\dev\Msc.Www\Web.ASP\App_Data\github\web-forms\overview\deployment\web-deployment-in-the-enterprise\manually-installing-web-packages.md) | [Edit dev content](http://www.aspdev.net/umbraco#/content/content/edit/38157) | [View dev content](http://docs.aspdev.net/tutorials/web-forms/overview/deployment/web-deployment-in-the-enterprise/manually-installing-web-packages.html) | [View prod content](http://www.asp.net/web-forms/overview/deployment/web-deployment-in-the-enterprise/manually-installing-web-packages) | Picker: 38235
...
>[!div class="step-by-step"] [Previous](creating-and-running-a-deployment-command-file.md)