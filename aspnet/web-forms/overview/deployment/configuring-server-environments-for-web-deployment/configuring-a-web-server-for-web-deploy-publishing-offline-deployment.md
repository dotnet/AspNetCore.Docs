...
4. Type this command, and then press Enter:
    ...
    [!code[Main](configuring-a-web-server-for-web-deploy-publishing-offline-deployment/samples/sample1.xml)]
...
6. Type this command, and then press Enter:
    ...
    [!code[Main](configuring-a-web-server-for-web-deploy-publishing-offline-deployment/samples/sample2.xml)]
