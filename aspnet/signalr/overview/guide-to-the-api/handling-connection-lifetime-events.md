...
[!code[Main](handling-connection-lifetime-events/samples/sample1.xml?highlight=1,3)]

**JavaScript client code: accessing `lastError` in the `disconnect` event.**

[!code[Main](handling-connection-lifetime-events/samples/sample2.xml?highlight=2-3)]