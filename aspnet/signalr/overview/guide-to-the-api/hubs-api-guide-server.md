...
[!code[Main](hubs-api-guide-server/samples/sample1.xml?highlight=1)]
...
[!code[Main](hubs-api-guide-server/samples/sample6.xml?highlight=1)]
...
[!code[Main](hubs-api-guide-server/samples/sample7.xml?highlight=1)]
...
[!code[Main](hubs-api-guide-server/samples/sample9.xml?highlight=3)]

[!code[Main](hubs-api-guide-server/samples/sample10.xml?highlight=3)]
...
[!code[Main](hubs-api-guide-server/samples/sample12.xml?highlight=1)]

If you want to specify a different name for clients to use, add the `HubMethodName` attribute.

**Server**

[!code[Main](hubs-api-guide-server/samples/sample13.xml?highlight=1)]

**JavaScript client using generated proxy**

[!code[Main](hubs-api-guide-server/samples/sample14.xml?highlight=1)]
...
[!code[Main](hubs-api-guide-server/samples/sample15.xml?highlight=1,7-8)]
...
[!code[Main](hubs-api-guide-server/samples/sample16.xml?highlight=5)]
...
[!code[Main](hubs-api-guide-server/samples/sample18.xml?highlight=3)]

**Server code that defines the complex object**

[!code[Main](hubs-api-guide-server/samples/sample19.xml?highlight=1)]

**JavaScript client using generated proxy**

[!code[Main](hubs-api-guide-server/samples/sample20.xml?highlight=2-3)]
...
[!code[Main](hubs-api-guide-server/samples/sample21.xml?highlight=1,3)]
...
[!code[Main](hubs-api-guide-server/samples/sample22.xml?highlight=5,10)]
...
[!code[Main](hubs-api-guide-server/samples/sample23.xml?highlight=1,3)]
...
[!code[Main](hubs-api-guide-server/samples/sample24.xml?highlight=3,14,22)]
...
- The connection ID of the calling client.
    ...
    [!code[Main](hubs-api-guide-server/samples/sample25.xml?highlight=1)]
...
- Query string data.
    ...
    [!code[Main](hubs-api-guide-server/samples/sample27.xml?highlight=1)]
    ...
    [!code[Main](hubs-api-guide-server/samples/sample28.xml?highlight=1)]
...
- Cookies.
    ...
    [!code[Main](hubs-api-guide-server/samples/sample29.xml?highlight=1)]

    You can also get cookies from `Context.RequestCookies`.
- User information.

    [!code[Main](hubs-api-guide-server/samples/sample30.xml?highlight=1)]
- The HttpContext object for the request :

    [!code[Main](hubs-api-guide-server/samples/sample31.xml?highlight=1)]
...
[!code[Main](hubs-api-guide-server/samples/sample32.xml?highlight=1-2)]

The following example shows the equivalent code in a .NET client.

[!code[Main](hubs-api-guide-server/samples/sample33.xml?highlight=1-2)]
...
[!code[Main](hubs-api-guide-server/samples/sample34.xml?highlight=3-4)]
...
[!code[Main](hubs-api-guide-server/samples/sample35.xml?highlight=3-4)]
...
- Create a Hubs pipeline module that handles the [OnIncomingError](https://msdn.microsoft.com/en-us/library/microsoft.aspnet.signalr.hubs.hubpipelinemodule.onincomingerror(v=vs.111).aspx) method. The following example shows a pipeline module that logs errors, followed by code in Startup.cs that injects the module into the Hubs pipeline.
    ...
    [!code[Main](hubs-api-guide-server/samples/sample36.xml?highlight=4)]
...
[!code[Main](hubs-api-guide-server/samples/sample37.xml?highlight=17-72)]
...
[!code[Main](hubs-api-guide-server/samples/sample38.xml?highlight=8,24)]
...
[!code[Main](hubs-api-guide-server/samples/sample39.xml?highlight=12,36)]
...
[!code[Main](hubs-api-guide-server/samples/sample40.xml?highlight=3)]
