...
[!code[Main](hubs-api-guide-net-client/samples/sample5.xml)]

The following example shows how to read a query string parameter in server code.

[!code[Main](hubs-api-guide-net-client/samples/sample6.xml?highlight=5)]
...
[!code[Main](hubs-api-guide-net-client/samples/sample7.xml?highlight=4)]
...
[!code[Main](hubs-api-guide-net-client/samples/sample9.xml?highlight=2)]
...
[!code[Main](hubs-api-guide-net-client/samples/sample10.xml?highlight=1)]
...
[!code[Main](hubs-api-guide-net-client/samples/sample12.xml)]

**Create client proxy for the Hub class**

[!code[Main](hubs-api-guide-net-client/samples/sample13.xml?highlight=2)]
...
[!code[Main](hubs-api-guide-net-client/samples/sample14.xml?highlight=5)]
...
[!code[Main](hubs-api-guide-net-client/samples/sample15.xml)]
...
[!code[Main](hubs-api-guide-net-client/samples/sample16.xml?highlight=3)]

**The Stock class used for the parameter**

[!code[Main](hubs-api-guide-net-client/samples/sample17.xml)]
...
[!code[Main](hubs-api-guide-net-client/samples/sample18.xml?highlight=1,5)]
...
[!code[Main](hubs-api-guide-net-client/samples/sample20.xml)]
...
[!code[Main](hubs-api-guide-net-client/samples/sample21.xml?highlight=1,5)]
...
[!code[Main](hubs-api-guide-net-client/samples/sample22.xml?highlight=1)]

**Client code to remove the handler**

[!code[Main](hubs-api-guide-net-client/samples/sample23.xml?highlight=1)]
...
[!code[Main](hubs-api-guide-net-client/samples/sample24.xml?highlight=3)]

**Client code calling a method that has no return value**

[!code[Main](hubs-api-guide-net-client/samples/sample25.xml?highlight=1)]
...
[!code[Main](hubs-api-guide-net-client/samples/sample30.xml)]
...
[!code[Main](hubs-api-guide-net-client/samples/sample31.xml?highlight=2)]

<a id="handleerrors"></a>

To handle errors that SignalR raises, you can add a handler for the `Error` event on the connection object.

[!code[Main](hubs-api-guide-net-client/samples/sample32.xml)]

To handle errors from method invocations, wrap the code in a try-catch block.

[!code[Main](hubs-api-guide-net-client/samples/sample33.xml)]
...
[!code[Main](hubs-api-guide-net-client/samples/sample34.xml?highlight=2-3)]
...
[!code[Main](hubs-api-guide-net-client/samples/sample43.xml?highlight=1-2)]