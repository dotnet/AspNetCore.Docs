...
Select the ASP.NET Core 1.0 Web site template from the set of ASP.NET Core 1.0 templates. Make sure you have Individual Authentication selected for this template. After selecting, click OK.
...
- Make a note of your App ID and your App Secret so that you can add both into your ASP.NET Core 1.0 Web site later in this tutorial. Also, Add your Site URL (https://localhost:44300/) to test your application.
