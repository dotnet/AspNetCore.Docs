...
See also the source code for ASP.NET Identity's `PasswordHasher <https://github.com/aspnet/Identity/blob/dev/src/Microsoft.AspNetCore.Identity/PasswordHasher.cs>`_ type for a real-world use case.
