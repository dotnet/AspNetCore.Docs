...
See also the source code for ASP.NET Core Identity's `PasswordHasher <https://github.com/aspnet/Identity/blob/master/src/Microsoft.AspNet.Identity/PasswordHasher.cs>`_ type for a real-world use case.
