...
The `ASP.NET generator <https://www.npmjs.com/package/generator-aspnet>`__ creates ASP.NET Core 1.0 DNX projects that can be loaded into Visual Studio 2015 or run from the command line.
...
The ASP.NET Core 1.0 Yeoman generator (``generator-aspnet``) uses Gulp out-of-the box. This is consistent with how the default ASP.NET web project template works in Visual Studio 2015.
...
You can load your generated ASP.NET Core 1.0 web project directly into Visual Studio 2015, then build and run your project from there.
