...
---
[Edit .md file](C:\Projects\msc\dev\Msc.Www\Web.ASP\App_Data\github\aspnet\overview\developing-apps-with-windows-azure\building-real-world-cloud-apps-with-windows-azure\transient-fault-handling.md) | [Edit dev content](http://www.aspdev.net/umbraco#/content/content/edit/53589) | [View dev content](http://docs.aspdev.net/tutorials/aspnet/overview/developing-apps-with-windows-azure/building-real-world-cloud-apps-with-windows-azure/transient-fault-handling.html) | [View prod content](http://www.asp.net/aspnet/overview/developing-apps-with-windows-azure/building-real-world-cloud-apps-with-windows-azure/transient-fault-handling) | Picker: 53622
...
>[!div class="step-by-step"] [Previous](monitoring-and-telemetry.md) [Next](distributed-caching.md)