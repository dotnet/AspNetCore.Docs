...
---
[Edit .md file](C:\Projects\msc\dev\Msc.Www\Web.ASP\App_Data\github\aspnet\overview\developing-apps-with-windows-azure\building-real-world-cloud-apps-with-windows-azure\the-fix-it-sample-application.md) | [Edit dev content](http://www.aspdev.net/umbraco#/content/content/edit/53573) | [View dev content](http://docs.aspdev.net/tutorials/aspnet/overview/developing-apps-with-windows-azure/building-real-world-cloud-apps-with-windows-azure/the-fix-it-sample-application.html) | [View prod content](http://www.asp.net/aspnet/overview/developing-apps-with-windows-azure/building-real-world-cloud-apps-with-windows-azure/the-fix-it-sample-application) | Picker: 53617
...
[!code[Main](the-fix-it-sample-application/samples/sample1.xml?highlight=1,3)]
...
[!code[Main](the-fix-it-sample-application/samples/sample2.xml?highlight=2)]
...
[!code[Main](the-fix-it-sample-application/samples/sample3.xml?highlight=9-14,24-29)]

### Don't swallow exceptions

The original Fix It app just returned null after logging an exception that resulted from a SQL query:

[!code[Main](the-fix-it-sample-application/samples/sample4.xml?highlight=4)]
...
[!code[Main](the-fix-it-sample-application/samples/sample5.xml?highlight=4,7,10,12,14)]
...
[!code[Main](the-fix-it-sample-application/samples/sample6.xml?highlight=3)]
...
[!code[Main](the-fix-it-sample-application/samples/sample7.xml?highlight=1)]
...
[!code[Main](the-fix-it-sample-application/samples/sample8.xml?highlight=11)]
...
[!code[Main](the-fix-it-sample-application/samples/sample9.xml?highlight=2-7)]
...
[!code[Main](the-fix-it-sample-application/samples/sample10.xml?highlight=9)]
...
[!code[Main](the-fix-it-sample-application/samples/sample11.xml?highlight=4-5)]
...
3. In the application *Web.config* file in the *MyFixIt* project (the web project), change the value of `appSettings/UseQueues` to "true": 
    ...
    [!code[Main](the-fix-it-sample-application/samples/sample12.xml?highlight=3)]
...
[!code[Main](the-fix-it-sample-application/samples/sample13.xml?highlight=2-3)]
...
[!code[Main](the-fix-it-sample-application/samples/sample14.xml?highlight=3)]
