...
.. literalinclude::  intro/samples/cu/Controllers/StudentsController.cs
  ...
  :end-before:  #endregion
  :emphasize-lines: 1-5,7,11-18,45-46
  :dedent: 8
...
.. note:: In the 1.0 version of Entity Framework Core, the entire result set is returned to the client, and grouping is done on the client. In some scenarios this could create performance problems. Be sure to test performance with production volumes of data, and if necessary use raw SQL to do the grouping on the server. For information about how to use raw SQL, see :doc:`the last tutorial in this series </data/ef-mvc/advanced>`.
