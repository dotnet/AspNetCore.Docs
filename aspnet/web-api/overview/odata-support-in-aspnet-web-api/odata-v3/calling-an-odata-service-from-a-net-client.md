...
[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample1.xml)]
...
[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample2.xml)]
...
[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample3.xml)]

## Query the Service

The following code gets the list of products from the OData service.

[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample4.xml)]
...
[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample5.xml)]

To get an entity by ID, use a `where` clause.

[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample6.xml)]
...
[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample7.xml)]

This code corresponds to the following OData query.

[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample8.xml)]
...
[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample9.xml)]

Here is the corresponding OData request.

[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample10.xml)]
...
[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample11.xml)]

Here is the corresponding OData request:

[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample12.xml)]
...
[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample13.xml)]

Here is the corresponding OData request:

[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample14.xml)]
...
[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample15.xml)]

Here is the corresponding OData request:

[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample16.xml)]
...
[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample17.xml)]

Here is the corresponding OData request. Notice that it includes the **$expand** option.

[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample18.xml)]
...
[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample19.xml)]
...
[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample20.xml)]
...
[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample21.xml)]
...
[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample22.xml)]

## Delete an Entity

To delete an entity, call **DeleteObject**.

[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample23.xml)]
...
[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample24.xml)]
...
[!code[Main](calling-an-odata-service-from-a-net-client/samples/sample25.xml)]