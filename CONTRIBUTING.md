...
For an example where this process led to publication of a new article, see [Issue &num;1477](https://github.com/dotnet/docs/issues/1477) and [Pull Request &num;18955](https://github.com/dotnet/docs/pull/18955) in the .NET Docs repository. The new article is [Documenting your code](https://docs.microsoft.com/dotnet/articles/csharp/codedoc).
