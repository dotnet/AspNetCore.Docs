...
# -*- coding: utf-8 -*-
#
# ASP.NET WebHooks documentation build configuration file, created by
...
htmlhelp_basename = 'aspnetwebhooks'
...
latex_documents = [
  (master_doc, 'apsnetwebhooks.tex', 'ASP.NET WebHooks Documentation',
   'Microsoft', 'manual'),
]
...
man_pages = [
    (master_doc, 'aspnetwebhooks', 'ASP.NET WebHooks Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'aspnetwebhooks', 'ASP.NET WebHooks Documentation',
   author, 'aspnetwebhooks', 'ASP.NET WebHooks Documentation',
   '.NET Development'),
]
